...
Fx = require './libs/td'
local Tshaktt =  require('tdlua') 
local client = Tshaktt()
local tdf = Fx.xnxx()
...
bot = Fx.Tshakbots.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=Tshak,token=Token}
chsource = Redis:get(Tshak..'chsource') or "COURSE_CAESAR"
devsource = Redis:get(Tshak..'devsource') or "c_a_s_e_r_h"
function var(value)  
...
if v:match(".lua$") and not Redis:sismember(Tshak..'files',v) then
...
if src_files and src_files.Tshak and msg then
results = src_files.Tshak(msg)
end
end
end
end
...
shh = tostring(text)
if Redis:get(Tshak..'rmzsource') then
shh = shh:gsub("• ",Redis:get(Tshak..'rmzsource'))
end
local listm = Redis:smembers(Tshak.."Words:r")
for k,v in pairs(listm) do
i ,j  = string.find(shh, v)
if j and i then
local x = string.sub(shh, i,j)
local neww = Redis:get(Tshak.."Word:Replace"..x)  
shh = shh:gsub(x,neww)
else
shh = shh
end
...
sh = tostring(text)
if Redis:get(Tshak..'rmzsource') then
sh = sh:gsub("• ",Redis:get(Tshak..'rmzsource'))
end
local listm = Redis:smembers(Tshak.."Words:r")
for k,v in pairs(listm) do
...
if Redis:sismember(Tshak.."ControlAll:Groups",UserId) then
ControllerAll = true
end
end
...
mderall = false
local statuse = Redis:sismember(Tshak.."Specialall:Group",senderr)
if statuse then
mderall = true
end
return mderall
...
Status = 0
local Controll2 = Redis:sismember(Tshak.."ControlAll:Groups",UserId)
Devss = Redis:sismember(Tshak.."Devss:Groups",UserId) 
...
local Controll2 = Redis:sismember(Tshak.."ControlAll:Groups",UserId)
Dev = Redis:sismember(Tshak.."Dev:Groups",UserId) 
Devss = Redis:sismember(Tshak.."Devss:Groups",UserId) 
Ownerss = Redis:sismember(Tshak.."Ownerss:Group"..ChatId,UserId) 
SuperCreator = Redis:sismember(Tshak.."SuperCreator:Group"..ChatId,UserId) 
Creator = Redis:sismember(Tshak.."Creator:Group"..ChatId,UserId)
Manger = Redis:sismember(Tshak.."Manger:Group"..ChatId,UserId)
Admin = Redis:sismember(Tshak.."Admin:Group"..ChatId,UserId)
Special = Redis:sismember(Tshak.."Special:Group"..ChatId,UserId)
StatusMember = bot.getChatMember(ChatId,UserId).status.Tshakbots
if UserId == 2100004938 then
...
elseif Dev then
Status = Redis:get(Tshak..'SetRt'..ChatId..':'..UserId) or Redis:get(Tshak.."Developer:Bot:Reply"..ChatId) or 'المطـــور '
elseif Ownerss then
Status = Redis:get(Tshak..'SetRt'..ChatId..':'..UserId) or Redis:get(Tshak.."PresidentQ:Group:Reply"..ChatId) or  'المــــــالك 🌟'
elseif SuperCreator then
Status = Redis:get(Tshak..'SetRt'..ChatId..':'..UserId) or Redis:get(Tshak.."President:Group:Reply"..ChatId) or 'المنشئ الاساسي 🌟'
elseif Creator then
Status = Redis:get(Tshak..'SetRt'..ChatId..':'..UserId) or Redis:get(Tshak.."Constructor:Group:Reply"..ChatId) or 'المنشــىء 🌟'
elseif Manger then
Status = Redis:get(Tshak..'SetRt'..ChatId..':'..UserId) or Redis:get(Tshak.."Manager:Group:Reply"..ChatId) or 'المـــــدير 🌟'
elseif Admin then
Status = Redis:get(Tshak..'SetRt'..ChatId..':'..UserId) or Redis:get(Tshak.."Admin:Group:Reply"..ChatId) or 'الادمـــــن 🌟'
elseif StatusMember == "chatMemberStatusCreator" then
Status = Redis:get(Tshak..'SetRt'..ChatId..':'..UserId) or 'مالك الجروب'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = Redis:get(Tshak..'SetRt'..ChatId..':'..UserId) or 'مشرف الجروب'
elseif Special then
Status = Redis:get(Tshak..'SetRt'..ChatId..':'..UserId) or Redis:get(Tshak.."Vip:Group:Reply"..ChatId) or 'المميــز ⭐️'
else
Status = Redis:get(Tshak..'SetRt'..ChatId..':'..UserId) or Redis:get(Tshak.."Mempar:Group:Reply"..ChatId) or 'العضـو'
end  
return Status
end 
...
if Redis:sismember(Tshak.."BanGroup:Group"..chat,useri) then
BanGroupz = "✔"
else
BanGroupz = "❌"
end
if Redis:sismember(Tshak.."SilentGroup:Group"..chat,useri) then
SilentGroupz = "✔"
else
SilentGroupz = "❌"
end
if Redis:sismember(Tshak.."SuperCreator:Group"..chat,useri)  then
SuperCreatorz = "✔"
else
SuperCreatorz = "❌"
end
if Redis:sismember(Tshak.."Creator:Group"..chat,useri) then
Creatorz = "✔"
else
Creatorz = "❌"
end
if Redis:sismember(Tshak.."Manger:Group"..chat,useri) then
Mangerz = "✔"
else
Mangerz = "❌"
end
if Redis:sismember(Tshak.."Admin:Group"..chat,useri) then
Adminz = "✔"
else
Adminz = "❌"
end
if Redis:sismember(Tshak.."Special:Group"..chat,useri) then
Specialz = "✔"
else
Specialz = "❌"
end
...
if Redis:get(Tshak.."Lock:phshar"..ChatId) then    
alphsar = "✔️"
else 
alphsar = "❌"    
end
if Redis:get(Tshak.."Lock:alkfr"..ChatId) then    
alkfr = "✔️"
else 
alkfr = "❌"    
end
if Redis:get(Tshak.."Lock:tphlesh"..ChatId) then    
tphlesh = "✔️"
else 
tphlesh = "❌"    
end
if Redis:get(Tshak.."Lock:farsia"..ChatId) then    
farsia = "✔️"
else 
farsia = "❌"    
end

if Redis:get(Tshak.."lockpin"..ChatId) then    
lock_pin = "✔️"
else 
lock_pin = "❌"    
end
if Redis:get(Tshak.."Lock:tagservr"..ChatId) then    
lock_tagservr = "✔️"
else 
lock_tagservr = "❌"
end
if Redis:get(Tshak.."Lock:text"..ChatId) then    
lock_text = "✔️"
else 
lock_text = "❌ "    
end
if Redis:get(Tshak.."Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✔️"
else 
lock_add = "❌ "    
end    
if Redis:get(Tshak.."Lock:Join"..ChatId) == "kick" then
lock_join = "✔️"
else 
lock_join = "❌ "    
end    
if Redis:get(Tshak.."Lock:edit"..ChatId) then    
lock_edit = "✔️"
else 
lock_edit = "❌ "    
end
if Redis:get(Tshak.."Chek:Welcome"..ChatId) then
welcome = "✔️"
else 
welcome = "❌ "    
end
if Redis:hget(Tshak.."Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(Tshak.."Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقييد "     
elseif Redis:hget(Tshak.."Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(Tshak.."Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✔️"
else     
flood = "❌ "     
end
if Redis:get(Tshak.."Lock:Photo"..ChatId) == "del" then
lock_photo = "✔️" 
elseif Redis:get(Tshak.."Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقييد "   
elseif Redis:get(Tshak.."Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(Tshak.."Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❌ "   
end    
if Redis:get(Tshak.."Lock:Contact"..ChatId) == "del" then
lock_phon = "✔️" 
elseif Redis:get(Tshak.."Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقييد "    
elseif Redis:get(Tshak.."Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(Tshak.."Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❌ "    
end    
if Redis:get(Tshak.."Lock:Link"..ChatId) == "del" then
lock_links = "✔️"
elseif Redis:get(Tshak.."Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقييد "    
elseif Redis:get(Tshak.."Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(Tshak.."Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❌ "    
end
if Redis:get(Tshak.."Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✔️"
elseif Redis:get(Tshak.."Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقييد "    
elseif Redis:get(Tshak.."Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(Tshak.."Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❌ "    
end
if Redis:get(Tshak.."Lock:User:Name"..ChatId) == "del" then
lock_user = "✔️"
elseif Redis:get(Tshak.."Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقييد "    
elseif Redis:get(Tshak.."Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(Tshak.."Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❌ "    
end
if Redis:get(Tshak.."Lock:hashtak"..ChatId) == "del" then
lock_hash = "✔️"
elseif Redis:get(Tshak.."Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقييد "    
elseif Redis:get(Tshak.."Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(Tshak.."Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❌ "    
end
if Redis:get(Tshak.."Lock:vico"..ChatId) == "del" then
lock_muse = "✔️"
elseif Redis:get(Tshak.."Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقييد "    
elseif Redis:get(Tshak.."Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(Tshak.."Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❌ "    
end 
if Redis:get(Tshak.."Lock:Video"..ChatId) == "del" then
lock_ved = "✔️"
elseif Redis:get(Tshak.."Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقييد "    
elseif Redis:get(Tshak.."Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(Tshak.."Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❌ "    
end
if Redis:get(Tshak.."Lock:Animation"..ChatId) == "del" then
lock_gif = "✔️"
elseif Redis:get(Tshak.."Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقييد "    
elseif Redis:get(Tshak.."Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(Tshak.."Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❌ "    
end
if Redis:get(Tshak.."Lock:Sticker"..ChatId) == "del" then
lock_ste = "✔️"
elseif Redis:get(Tshak.."Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقييد "    
elseif Redis:get(Tshak.."Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(Tshak.."Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❌ "    
end
if Redis:get(Tshak.."Lock:geam"..ChatId) == "del" then
lock_geam = "✔️"
elseif Redis:get(Tshak.."Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقييد "    
elseif Redis:get(Tshak.."Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(Tshak.."Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❌ "    
end    
...
if Redis:get(Tshak.."Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✔️"
elseif Redis:get(Tshak.."Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقييد "
elseif Redis:get(Tshak.."Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(Tshak.."Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❌ "
end
if Redis:get(Tshak.."Lock:forward"..ChatId) == "del" then
lock_fwd = "✔️"
elseif Redis:get(Tshak.."Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقييد "    
elseif Redis:get(Tshak.."Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(Tshak.."Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❌ "    
end    
if Redis:get(Tshak.."Lock:Document"..ChatId) == "del" then
lock_file = "✔️"
elseif Redis:get(Tshak.."Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقييد "    
elseif Redis:get(Tshak.."Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(Tshak.."Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❌ "    
end    
if Redis:get(Tshak.."Lock:Unsupported"..ChatId) == "del" then
lock_self = "✔️"
elseif Redis:get(Tshak.."Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقييد "    
elseif Redis:get(Tshak.."Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(Tshak.."Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❌ "    
end
if Redis:get(Tshak.."Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✔️"
elseif Redis:get(Tshak.."Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقييد "   
elseif Redis:get(Tshak.."Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❌ "    
end
if Redis:get(Tshak.."Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✔️"
elseif Redis:get(Tshak.."Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقييد "    
elseif Redis:get(Tshak.."Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(Tshak.."Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❌ "    
end
if Redis:get(Tshak.."Lock:Spam"..ChatId) == "del" then    
lock_spam = "✔️"
elseif Redis:get(Tshak.."Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقييد "    
elseif Redis:get(Tshak.."Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(Tshak.."Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❌ "    
end        
...
return{
KtmAll = Redis:sismember(Tshak.."KtmAll:Groups",UserId) ,
BanAll = Redis:sismember(Tshak.."BanAll:Groups",UserId) ,
BanGroup = Redis:sismember(Tshak.."BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(Tshak.."SilentGroup:Group"..ChatId,UserId)
}
end
...
local GetMemberStatus = bot.getChatMember(msg.chat_id,Tshak).status 
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local Channel = Redis:get(Tshak..'Chat:Channel:Join'..msg.chat_id)
if Channel then
...
JoinChannel = true
if not Redis:sismember(Tshak.."BotFree:Group:",msg.chat_id) then
local Channel = Redis:get(Tshak..'Channel:Join')
if Channel then
local url , res = https.request('https://api.telegram.org/bot'..Token..'/getchatmember?chat_id=@'..Channel..'&user_id='..senderr)
local ChannelJoin = JSON.decode(url)
if ChannelJoin.result.status == "left" then
...
--[[
if msg.content.voice_note and Redis:get(Tshak..msg_chat_id.."sound:cmd") then 
...
xname =  (Redis:get(Tshak.."Name:Bot") or "[قيصر]") 
...
elseif Redis:sismember(Tshak.."Devss:Groups",senderr) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطـور الثانوي '
elseif Redis:sismember(Tshak.."Dev:Groups",senderr) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(Tshak..'SetRt'..msg.chat_id..':'..senderr) or Redis:get(Tshak.."Developer:Bot:Reply"..msg.chat_id) or 'المطـــور  '
elseif Redis:sismember(Tshak.."Ownerss:Group"..msg.chat_id,senderr) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(Tshak..'SetRt'..msg.chat_id..':'..senderr) or Redis:get(Tshak.."PresidentQ:Group:Reply"..msg.chat_id) or 'المــــــالك 🌟 '
elseif Redis:sismember(Tshak.."SuperCreator:Group"..msg.chat_id,senderr) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(Tshak..'SetRt'..msg.chat_id..':'..senderr) or Redis:get(Tshak.."President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي 🌟'
elseif Redis:sismember(Tshak.."Creator:Group"..msg.chat_id,senderr) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(Tshak..'SetRt'..msg.chat_id..':'..senderr) or Redis:get(Tshak.."Constructor:Group:Reply"..msg.chat_id) or 'المنشــىء 🌟 '
elseif Redis:sismember(Tshak.."Manger:Group"..msg.chat_id,senderr) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(Tshak..'SetRt'..msg.chat_id..':'..senderr) or Redis:get(Tshak.."Manager:Group:Reply"..msg.chat_id) or 'المــــدير 🌟 '
elseif Redis:sismember(Tshak.."Admin:Group"..msg.chat_id,senderr) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(Tshak..'SetRt'..msg.chat_id..':'..senderr) or Redis:get(Tshak.."Admin:Group:Reply"..msg.chat_id) or 'الادمـــــن 🌟 '
elseif Redis:sismember(Tshak.."Special:Group"..msg.chat_id,senderr) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(Tshak..'SetRt'..msg.chat_id..':'..senderr) or Redis:get(Tshak.."Vip:Group:Reply"..msg.chat_id) or 'المميــز ⭐️ '
elseif tonumber(senderr) == tonumber(Tshak) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(Tshak..'SetRt'..msg.chat_id..':'..senderr) or Redis:get(Tshak.."Mempar:Group:Reply"..msg.chat_id) or 'العضـو '
end  
...
if text and Redis:get(Tshak.."chmembers") == "on" then
if ChannelJoin(msg) == false then
local UserInfo = bot.getUser(msg.sender_id.user_id)
local n = UserInfo.first_name
local d = UserInfo.id
local chinfo = Redis:get(Tshak.."Channel:Redis")
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(Tshak..'Channel:Join')}, },}}
...
for v in io.popen('ls plugin'):lines() do
if Redis:sismember(Tshak..'files',v) then
state = "{معطل}"
else 
state = "{مفعل}"
end
...
if text then
local neww = Redis:get(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..text) or Redis:get(Tshak.."All:Get:Reides:Commands:Group"..text)
if neww and not Redis:get(Tshak.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender_id.user_id) then
text = neww or text
end
end
if msg.sender_id.Tshakbots ~= "messageSenderChat" then
...
if (Redis:get(Tshak..'All:FilterText'..msg_chat_id..':'..msg.sender_id.user_id) == 'DelFilterq') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.Tshakbots == "messagePhoto" then
Filters = 'الصوره'
Redis:srem(Tshak.."All:List:Filter",'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(Tshak.."All:Filter:Group:"..msg.content.photo.sizes[1].photo.id)  
elseif msg.content.Tshakbots == "messageAnimation" then
Filters = 'المتحركه'
Redis:srem(Tshak.."All:List:Filter",'animation:'..msg.content.animation.animation.id)  
Redis:del(Tshak.."All:Filter:Group:"..msg.content.animation.animation.id)  
elseif msg.content.Tshakbots == "messageSticker" then
Filters = 'الملصق'
Redis:srem(Tshak.."All:List:Filter",'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(Tshak.."All:Filter:Group:"..msg.content.sticker.sticker.id)  
elseif text then
Redis:srem(Tshak.."All:List:Filter",'text:'..text)  
Redis:del(Tshak.."All:Filter:Group:"..text)  
Filters = 'النص'
end
Redis:del(Tshak..'All:FilterText'..msg_chat_id..':'..msg.sender_id.user_id)
return send(msg_chat_id,msg_id,"• تم الغاء منع عام ("..Filters..")","md",true)  
end
end

if Redis:get(Tshak.."Lock:text"..msg_chat_id) and not msg.Special then
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.Tshakbots == "messageChatJoinByLink" and not msg.Special then
if Redis:get(Tshak.."Lock:Join"..msg.chat_id) == "kick" then
bot.setChatMemberStatus(msg.chat_id,msg.sender_id.user_id,'banned',0)
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end
end
if msg.content.Tshakbots == "messageChatAddMembers" then -- اضافه اشخاص
local Lock_Bots = Redis:get(Tshak.."Lock:Bot:kick"..msg_chat_id)
for k,v in pairs(msg.content.member_user_ids) do
if tonumber(v) ~= tonumber(Tshak) then
local Info_User = bot.getUser(v) 
if Info_User.type.Tshakbots == "userTypeBot" then
...
if msg.content.Tshakbots == "messageChatAddMembers" then
Redis:incr(Tshak.."Num:Add:Memp"..msg_chat_id..":"..msg.sender_id.user_id) 
end

if msg.content.Tshakbots == "messageChatJoinByLink" or msg.content.Tshakbots == "messageChatAddMembers" then
...
if msg.content.Tshakbots == "messageChatJoinByLink" or msg.content.Tshakbots == "messageChatAddMembers" then
if Redis:get(Tshak.."Status:Welcome"..msg_chat_id) then
local UserInfo = bot.getUser(msg.sender_id.user_id)
local Get_Chat = bot.getChat(msg_chat_id)
local Info_Chats = bot.getSupergroupFullInfo(msg_chat_id)
local Welcome = Redis:get(Tshak.."Welcome:Group"..msg_chat_id)
if Welcome then 
...
local GroupsWelcome = Redis:get(Tshak.."Welcome:Groups")
...
if not msg.Special and msg.content.Tshakbots ~= "messageChatAddMembers" and Redis:hget(Tshak.."Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender_id.user_id) == tonumber(Tshak) then
return false
end
local floods = Redis:hget(Tshak.."Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(Tshak.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(Tshak.."Spam:Cont"..msg.sender_id.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(Tshak.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(Tshak.."Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(Tshak.."SilentGroup:Group"..msg.chat_id,tonumber(msg.sender_id.user_id)) 
return send(msg_chat_id,msg_id,Reply_Status(msg.sender_id.user_id,"• قام بالتكرار في الجروب وتم كتمه").Reply,"md",true)  
end
end
Redis:setex(Tshak.."Spam:Cont"..msg.sender_id.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(Tshak.."Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(Tshak.."Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
sens = 400  
if Redis:get(Tshak.."Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
if Redis:get(Tshak..'AlThther:Chat'..msg.chat_id)  then
local num = Redis:get(Tshak..msg.sender_id.user_id..'inthaar'..msg.chat_id)
if not num then 
Redis:set(Tshak..msg.sender_id.user_id..'inthaar'..msg.chat_id,"1")
inth = "• عدد تحذيراتك 1"
elseif num == "1" then
Redis:set(Tshak..msg.sender_id.user_id..'inthaar'..msg.chat_id,"2")
inth = "• عدد تحذيراتك 2"
elseif num == "2" then
Redis:set(Tshak..msg.sender_id.user_id..'inthaar'..msg.chat_id,"3")
inth = "• عدد تحذيراتك 3"
elseif num == "3" then
Redis:del(Tshak..msg.sender_id.user_id..'inthaar'..msg.chat_id)
...
elseif Redis:get(Tshak.."Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
...
elseif Redis:get(Tshak.."Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
bot.setChatMemberStatus(msg.chat_id,msg.sender_id.user_id,'banned',0)
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
if Redis:get(Tshak..'AlThther:Chat'..msg.chat_id)  then
local num = Redis:get(Tshak..msg.sender_id.user_id..'inthaar'..msg.chat_id)
...
elseif Redis:get(Tshak.."Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(Tshak.."SilentGroup:Group"..msg.chat_id,tonumber(msg.sender_id.user_id))
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
if Redis:get(Tshak..'AlThther:Chat'..msg.chat_id)  then
local num = Redis:get(Tshak..msg.sender_id.user_id..'inthaar'..msg.chat_id)
...
local Fwd_Group = Redis:get(Tshak.."Lock:forward"..msg_chat_id)
...
Redis:sadd(Tshak.."SilentGroup:Group"..msg.chat_id,tounmber(msg.sender_id.user_id)) 
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
if Redis:get(Tshak..'AlThther:Chat'..msg.chat_id)  then
local num = Redis:get(Tshak..msg.sender_id.user_id..'inthaar'..msg.chat_id)
if not num then 
...
if msg.content.Tshakbots == "messagePhoto" or msg.content.Tshakbots == "messageAnimation" or msg.content.Tshakbots == "messageSticker" or msg.content.Tshakbots == "messageVoiceNote" or msg.content.Tshakbots == "messageVideo" or msg.content.Tshakbots == "messageAudio" or msg.content.Tshakbots == "messageVideoNote" then
if not msg.Admin then
if Redis:get(Tshak.."Lock:AlUasat"..msg_chat_id) then 
return bot.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
end

if msg.reply_markup and msg.reply_markup.Tshakbots == "replyMarkupInlineKeyboard" then
if not msg.Special then  -- الكيبورد
local Keyboard_Group = Redis:get(Tshak.."Lock:Keyboard"..msg_chat_id)
...
Redis:sadd(Tshak.."SilentGroup:Group"..msg.chat_id,toumber(msg.sender_id.user_id)) 
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
if Redis:get(Tshak..'AlThther:Chat'..msg.chat_id)  then
local num = Redis:get(Tshak..msg.sender_id.user_id..'inthaar'..msg.chat_id)
if not num then 
...
if msg.content.entities and msg..content.entities[0] and msg.content.entities[0].type.Tshakbots == "textEntityTypeUrl" and not msg.Special then  -- الماركداون
local Markduan_Gtoup = Redis:get(Tshak.."Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(Tshak.."Lock:geam"..msg_chat_id)
...
Redis:sadd(Tshak.."SilentGroup:Group"..msg.chat_id,msg.sender_id.user_id) 
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
if Redis:get(Tshak..'AlThther:Chat'..msg.chat_id)  then
local num = Redis:get(Tshak..msg.sender_id.user_id..'inthaar'..msg.chat_id)
if not num then 
...
if msg.content.Tshakbots == "messageChatJoinByLink" then
if Redis:get(Tshak.."Lock:Join"..msg.chat_id) == "kick" then
bot.setChatMemberStatus(msg.chat_id,msg.sender_id.user_id,'banned',0)
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
...
if msg.content.Tshakbots == "messageChatDeleteMember" and not Redis:get(Tshak.."spammkick"..msg.chat_id) then 
if msg.sender_id.user_id ~= Tshak then
Num_Msg_Max = 4
local UserInfo = bot.getUser(msg.sender_id.user_id)
local names = FlterBio(UserInfo.first_name)
local monsha = Redis:smembers(Tshak.."Ownerss:Group"..msg_chat_id) 
if Redis:ttl(Tshak.."mkal:setex:" .. msg.chat_id .. ":" .. msg.sender_id.user_id) < 0 then
Redis:del(Tshak.."delmembars"..msg.chat_id..msg.sender_id.user_id)
end
local ttsaa = (Redis:get(Tshak.."delmembars"..msg.chat_id..msg.sender_id.user_id) or 0)
if tonumber(ttsaa) >= tonumber(3) then 
local type = Redis:hget(Tshak.."Storm:Spam:Group:User"..msg.chat_id,"Spam:User") 
...
Redis:srem(Tshak.."SuperCreator:Group"..msg.chat_id,msg.sender_id.user_id)
Redis:srem(Tshak.."Creator:Group"..msg.chat_id,msg.sender_id.user_id)
Redis:srem(Tshak.."Manger:Group"..msg.chat_id,msg.sender_id.user_id)
Redis:srem(Tshak.."Admin:Group"..msg.chat_id,msg.sender_id.user_id)
Redis:srem(Tshak.."Special:Group"..msg.chat_id,msg.sender_id.user_id)
...
Redis:setex(Tshak.."mkal:setex:" .. msg.chat_id .. ":" .. msg.sender_id.user_id, 3600, true) 
Redis:incrby(Tshak.."delmembars"..msg.chat_id..msg.sender_id.user_id, 1)  
end
end 

if text and text:match('طرد @(.*)') or text and text:match('حظر @(.*)') or text and text:match('طرد (%d+)') or text and text:match('حظر (%d+)') then 
if not Redis:get(Tshak.."spammkick"..msg.chat_id) then 
if msg.sender_id.user_id ~= Tshak then
Num_Msg_Max = 4
local UserInfo = bot.getUser(msg.sender_id.user_id)
local names = FlterBio(UserInfo.first_name) 
local monsha = Redis:smembers(Tshak.."Ownerss:Group"..msg_chat_id) 
if Redis:ttl(Tshak.."qmkal:setex:" .. msg.chat_id .. ":" .. msg.sender_id.user_id) < 0 then
Redis:del(Tshak.."qdelmembars"..msg.chat_id..msg.sender_id.user_id)
end
local ttsaa = (Redis:get(Tshak.."qdelmembars"..msg.chat_id..msg.sender_id.user_id) or 0)
...
Redis:setex(Tshak.."qmkal:setex:" .. msg.chat_id .. ":" .. msg.sender_id.user_id, 3600, true) 
Redis:incrby(Tshak.."qdelmembars"..msg.chat_id..msg.sender_id.user_id, 1)  
end
end 
end

if msg.content.Tshakbots == "messagePhoto" and Redis:get(Tshak..'welcom_ph:witting'..msg.sender_id.user_id) then  -- الصور
...
Redis:set(Tshak..':WELCOME_BOT',idPhoto)
Redis:del(Tshak..'welcom_ph:witting'..msg.sender_id.user_id) 
...
Redis:incr(Tshak.."Num:Add:Memp"..msg_chat_id..":"..msg.sender_id.user_id) 
local AddMembrs = Redis:get(Tshak.."Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(Tshak.."Lock:Bot:kick"..msg_chat_id)
for k,v in pairs(msg.content.member_user_ids) do
if tonumber(v) == tonumber(Tshak) then
local idephoto = Redis:get(Tshak..':WELCOME_BOT')
if idephoto then
local Bot_Name = (Redis:get(Tshak.."Name:Bot") or "[قيصر]")
...
local Info_User = bot.getUser(v) 
if Info_User.type.Tshakbots == "userTypeRegular" then
...
if msg.content.Tshakbots == "messageContact" and not msg.Special then  -- الجهات
local Contact_Group = Redis:get(Tshak.."Lock:Contact"..msg_chat_id)
...
if msg.content.Tshakbots == "messageVideoNote" and not msg.Special then  -- بصمه الفيديو
local Videonote_Group = Redis:get(Tshak.."Lock:Unsupported"..msg_chat_id)
...
if msg.content.Tshakbots == "messageDocument" and not msg.Special then  -- الملفات
local Document_Group = Redis:get(Tshak.."Lock:Document"..msg_chat_id)
...
if msg.content.Tshakbots == "messageAudio" and not msg.Special then  -- الملفات الصوتيه
local Audio_Group = Redis:get(Tshak.."Lock:Audio"..msg_chat_id)
...
if msg.content.Tshakbots == "messageVideo" then  -- الفيديو
if Redis:sismember(Tshak.."Specialall:Group",msg.sender_id.user_id) then
testmod = true
...
local Video_Grouo = Redis:get(Tshak.."Lock:Video"..msg_chat_id)
...
if not msg.Special and Redis:get(Tshak.."Lock:english"..msg_chat_id) then
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
if Redis:get(Tshak..'AlThther:Chat'..msg.chat_id)  then
local num = Redis:get(Tshak..msg.sender_id.user_id..'inthaar'..msg.chat_id)
if not num then 
...
if msg.content.Tshakbots == "messageVoiceNote" and not msg.Special then  -- البصمات
local Voice_Group = Redis:get(Tshak.."Lock:vico"..msg_chat_id)
...
if msg.content.Tshakbots == "messageSticker" then  -- الملصقات
if Redis:sismember(Tshak.."Specialall:Group",msg.sender_id.user_id) then
testmod = true
elseif msg.Special then
testmod = true
...
if testmod == false then
local Sticker_Group = Redis:get(Tshak.."Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(Tshak.."Lock:Inlen"..msg_chat_id)
...
if msg.content.Tshakbots == "messageAnimation"  then  -- المتحركات
if Redis:sismember(Tshak.."Specialall:Group",msg.sender_id.user_id) then
testmod = true
elseif msg.Special then
testmod = true
...
if testmod == false then
local Gif_group = Redis:get(Tshak.."Lock:Animation"..msg_chat_id)
...
local phshar_Group = Redis:get(Tshak.."Lock:farsia"..msg_chat_id)
...
local phshar_Group = Redis:get(Tshak.."Lock:phshar"..msg_chat_id)
if phshar_Group then
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
if Redis:get(Tshak..'AlThther:Chat'..msg.chat_id)  then
local num = Redis:get(Tshak..msg.sender_id.user_id..'inthaar'..msg.chat_id)
...
local phsharr_Group = Redis:get(Tshak.."Lock:alkfr"..msg_chat_id)
...
if msg.content.Tshakbots == "messagePhoto" then  -- الصور
if Redis:sismember(Tshak.."Specialall:Group",msg.sender_id.user_id) then
testmod = true
elseif msg.Special then
testmod = true
...
if testmod == false then
local Photo_Group = Redis:get(Tshak.."Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(Tshak.."Chat:Photo"..msg_chat_id..":"..msg.sender_id.user_id) then
local ChatPhoto = bot.setChatPhoto(msg_chat_id,msg.content.photo.sizes[2].photo.remote.id)
if (ChatPhoto.Tshakbots == "error") then
Redis:del(Tshak.."Chat:Photo"..msg_chat_id..":"..msg.sender_id.user_id)
...
or msg.content.Tshakbots == "messageContact" 
or msg.content.Tshakbots == "messageSticker"
or msg.content.Tshakbots == "messageVideoNote" 
or msg.content.Tshakbots == "messageDocument" 
or msg.content.Tshakbots == "messageAudio" 
or msg.content.Tshakbots == "messageVideo" 
or msg.content.Tshakbots == "messageVoiceNote" 
or msg.content.Tshakbots == "messageAnimation" 
or msg.content.Tshakbots == "messagePhoto" then
local tphlesh_Group = Redis:get(Tshak.."Lock:tphlesh"..msg_chat_id)
...
local link_Group = Redis:get(Tshak.."Lock:Link"..msg_chat_id)  
if not msg.Admin then
...
if testmod == false then
local UserName_Group = Redis:get(Tshak.."Lock:User:Name"..msg_chat_id)
...
local Hashtak_Group = Redis:get(Tshak.."Lock:hashtak"..msg_chat_id)
...
local comd_Group = Redis:get(Tshak.."Lock:Cmd"..msg_chat_id)
...
if (Redis:get(Tshak..'FilterText'..msg_chat_id..':'..msg.sender_id.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(Tshak.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(Tshak.."Filter:Text"..msg.sender_id.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(Tshak.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(Tshak.."Filter:Text"..msg.sender_id.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(Tshak.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(Tshak.."Filter:Text"..msg.sender_id.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(Tshak.."Filter:Text"..msg.sender_id.user_id..':'..msg_chat_id, text)  
Redis:sadd(Tshak.."List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(Tshak..'FilterText'..msg_chat_id..':'..msg.sender_id.user_id,'true1')
return send(msg_chat_id,msg_id,"\n• ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(Tshak..'FilterText'..msg_chat_id..':'..msg.sender_id.user_id) == 'true1') then
local Text_Filter = Redis:get(Tshak.."Filter:Text"..msg.sender_id.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(Tshak.."Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(Tshak.."Filter:Text"..msg.sender_id.user_id..':'..msg_chat_id)  
Redis:del(Tshak..'FilterText'..msg_chat_id..':'..msg.sender_id.user_id)
return send(msg_chat_id,msg_id,"\n• تم اضافه رد التحذير","md",true)  
end
if (Redis:get(Tshak..'FilterText'..msg_chat_id..':'..msg.sender_id.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(Tshak.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(Tshak.."Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(Tshak.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(Tshak.."Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(Tshak.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(Tshak.."Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(Tshak.."List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(Tshak.."Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(Tshak..'FilterText'..msg_chat_id..':'..msg.sender_id.user_id)
...
local ReplyFilters = Redis:get(Tshak.."Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(Tshak..msg.chat_id..msg.sender_id.user_id.."replace") == "true1" then
Redis:del(Tshak..msg.chat_id..msg.sender_id.user_id.."replace")
local word = Redis:get(Tshak..msg.sender_id.user_id.."word")
Redis:set(Tshak.."Word:Replace"..word,text)
Redis:sadd(Tshak..'Words:r',word)  
bot.sendText(msg_chat_id,msg_id,"• تم حفظ الكلمه","md",true)  
return false 
end
if text and Redis:get(Tshak..msg.chat_id..msg.sender_id.user_id.."replace") == "true" then
Redis:set(Tshak..msg.sender_id.user_id.."word",text)
Redis:set(Tshak..msg.chat_id..msg.sender_id.user_id.."replace","true1")
bot.sendText(msg_chat_id,msg_id,'\n• ارسل كلمه جديده ليتم استبدالها مكان *'..text..'*',"md",true)  
return false 
end
if text and Redis:get(Tshak.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender_id.user_id) == "true" then
local NewCmmd = Redis:get(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(Tshak.."Command:Reids:Group:New"..msg_chat_id)
Redis:srem(Tshak.."Command:List:Group"..msg_chat_id,text)
send(msg_chat_id,msg_id,"• تم ازالة هذا الامر ← { "..text.." }","md",true)
else
send(msg_chat_id,msg_id,"• لا يوجد امر بهذا الاسم","md",true)
end
Redis:del(Tshak.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender_id.user_id)
return false
end
if text and Redis:get(Tshak.."Command:Reids:Group"..msg_chat_id..":"..msg.sender_id.user_id) == "true" then
Redis:set(Tshak.."Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(Tshak.."Command:Reids:Group"..msg_chat_id..":"..msg.sender_id.user_id)
Redis:set(Tshak.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender_id.user_id,"true1") 
return send(msg_chat_id,msg_id,"• ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(Tshak.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender_id.user_id) == "true1" then
local NewCmd = Redis:get(Tshak.."Command:Reids:Group:New"..msg_chat_id)
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(Tshak.."Command:List:Group"..msg_chat_id,text)
Redis:del(Tshak.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender_id.user_id)
return send(msg_chat_id,msg_id,"• تم حفظ الامر باسم ← { "..text..' }',"md",true)
end
if Redis:get(Tshak.."Set:Link"..msg_chat_id..""..msg.sender_id.user_id) then
if text == "الغاء" then
Redis:del(Tshak.."Set:Link"..msg_chat_id..""..msg.sender_id.user_id) 
...
Redis:set(Tshak.."Group:Link"..msg_chat_id,LinkGroup)
Redis:del(Tshak.."Set:Link"..msg_chat_id..""..msg.sender_id.user_id) 
return send(msg_chat_id,msg_id,"• تم حفظ الرابط بنجاح","md",true)         
end
end 
if Redis:get(Tshak.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender_id.user_id) then 
if text == "الغاء" then 
Redis:del(Tshak.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender_id.user_id)  
return send(msg_chat_id,msg_id,"• تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(Tshak.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender_id.user_id)  
Redis:set(Tshak.."Welcome:Group"..msg_chat_id,text) 
return send(msg_chat_id,msg_id,"• تم حفظ ترحيب الجروب","md",true)     
end
if Redis:get(Tshak.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender_id.user_id) then 
if text == "الغاء" then 
Redis:del(Tshak.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender_id.user_id)
return send(msg_chat_id,msg_id,"• تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(Tshak.."Group:Rules" .. msg_chat_id,text) 
Redis:del(Tshak.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender_id.user_id)
return send(msg_chat_id,msg_id,"• تم حفظ قوانين الجروب","md",true)  
end  
if Redis:get(Tshak.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender_id.user_id) then 
if text == "الغاء" then 
Redis:del(Tshak.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender_id.user_id)
...
local test = Redis:get(Tshak.."Text:Manager"..msg.sender_id.user_id..":"..msg_chat_id.."")
if Redis:get(Tshak.."Set:Manager:rd"..msg.sender_id.user_id..":"..msg_chat_id) == "true1" then
Redis:del(Tshak.."Set:Manager:rd"..msg.sender_id.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(Tshak.."Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(Tshak.."Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Tshak.."Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
if msg.content.audio then
if msg.content.caption.text then
Redis:set(Tshak.."Add:Rd:caption:audio"..msg.content.audio.audio.remote.id..msg_chat_id, msg.content.caption.text)  
end
Redis:set(Tshak.."Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
if msg.content.caption.text then
Redis:set(Tshak.."Add:Rd:caption:document"..msg.content.document.document.remote.id..msg_chat_id, msg.content.caption.text)  
end
Redis:set(Tshak.."Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
end
if msg.content.animation then
Redis:set(Tshak.."Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
end
if msg.content.video_note then
Redis:set(Tshak.."Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.video then
if msg.content.caption.text then
Redis:set(Tshak.."Add:Rd:caption:video"..msg.content.video.video.remote.id..msg_chat_id, msg.content.caption.text)  
end
Redis:set(Tshak.."Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if msg.content.caption.text then
Redis:set(Tshak.."Add:Rd:caption:Photo"..idPhoto..msg_chat_id, msg.content.caption.text)  
end
Redis:set(Tshak.."Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
end
return send(msg_chat_id,msg_id,"• تم حفظ الرد  بنجاح \n• ارسل ( ["..test.."] ) لعرض الرد","md",true)  
end  
end
if text and text:match("^(.*)$") then
if Redis:get(Tshak.."Set:Manager:rd"..msg.sender_id.user_id..":"..msg_chat_id) == "true" then
Redis:set(Tshak.."Set:Manager:rd"..msg.sender_id.user_id..":"..msg_chat_id,"true1")
Redis:set(Tshak.."Text:Manager"..msg.sender_id.user_id..":"..msg_chat_id, text)
Redis:del(Tshak.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(Tshak.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(Tshak.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(Tshak.."Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(Tshak.."Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(Tshak.."Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(Tshak.."Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(Tshak.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(Tshak.."Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(Tshak.."List:Manager"..msg_chat_id.."", text)
...
if text and text:match("^(.*)$") then
if Redis:get(Tshak.."Set:Manager:rd"..msg.sender_id.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(Tshak.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(Tshak.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(Tshak.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(Tshak.."Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(Tshak.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(Tshak.."Set:Manager:rd"..msg.sender_id.user_id..":"..msg_chat_id)
Redis:srem(Tshak.."List:Manager"..msg_chat_id.."", text)
send(msg_chat_id,msg_id,"• تم مسح الرد من الردود المضافه","md",true)  
return false
end
end
if text and Redis:get(Tshak.."Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(Tshak.."Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(Tshak.."Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(Tshak.."Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(Tshak.."Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(Tshak.."Add:Rd:Sudo:Photo"..text)
local video = Redis:get(Tshak.."Add:Rd:Sudo:Video"..text)
local document = Redis:get(Tshak.."Add:Rd:Sudo:File"..text)
local audio = Redis:get(Tshak.."Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(Tshak.."Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = bot.getUser(msg.sender_id.user_id)
local NumMsg = Redis:get(Tshak..'Num:Message:User'..msg_chat_id..':'..msg.sender_id.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(Tshak..'Num:Message:Edit'..msg_chat_id..msg.sender_id.user_id) or 0
...
if text and Redis:get(Tshak.."Status:Reply"..msg_chat_id) then
local anemi = Redis:get(Tshak.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(Tshak.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(Tshak.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(Tshak.."Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(Tshak.."Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(Tshak.."Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(Tshak.."Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(Tshak.."Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(Tshak.."Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = bot.getUser(msg.sender_id.user_id)
local NumMsg = Redis:get(Tshak..'Num:Message:User'..msg_chat_id..':'..msg.sender_id.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if photo then
local captionsend = Redis:get(Tshak.."Add:Rd:caption:Photo"..photo..msg_chat_id) or ''
...
if video then 
local captionsend = Redis:get(Tshak.."Add:Rd:caption:video"..video..msg_chat_id) or ''
...
if document then
local captionsend = Redis:get(Tshak.."Add:Rd:caption:document"..document..msg_chat_id) or ''
bot.sendDocument(msg_chat_id, msg.id, document, '['..captionsend..']', 'md')
end  
if audio then
local captionsend = Redis:get(Tshak.."Add:Rd:caption:audio"..audio..msg_chat_id) or ''
bot.sendAudio(msg_chat_id, msg.id, audio, '['..captionsend..']',"md")
end
end
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(Tshak.."Text:Sudo:Bot"..msg.sender_id.user_id..":"..msg_chat_id)
if Redis:get(Tshak.."Set:Rd"..msg.sender_id.user_id..":"..msg_chat_id) == "true1" then
Redis:del(Tshak.."Set:Rd"..msg.sender_id.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(Tshak.."Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(Tshak.."Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(Tshak.."Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Tshak.."Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content.audio then
Redis:set(Tshak.."Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(Tshak.."Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
end
if msg.content.video then
Redis:set(Tshak.."Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
end
if msg.content.video_note then
Redis:set(Tshak.."Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(Tshak.."Add:Rd:Sudo:Photo"..test, idPhoto)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(Tshak.."Set:Rd"..msg.sender_id.user_id..":"..msg_chat_id) == "true" then
Redis:set(Tshak.."Set:Rd"..msg.sender_id.user_id..":"..msg_chat_id, "true1")
Redis:set(Tshak.."Text:Sudo:Bot"..msg.sender_id.user_id..":"..msg_chat_id, text)
Redis:sadd(Tshak.."List:Rd:Sudo", text)
send(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف •ملصق •متحركه •صوره
 •فيديو •بصمه الفيديو •بصمه •صوت •رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(Tshak.."Set:On"..msg.sender_id.user_id..":"..msg_chat_id) == "true" then
...
Redis:del(Tshak..''..v..text)
end
Redis:del(Tshak.."Set:On"..msg.sender_id.user_id..":"..msg_chat_id)
Redis:srem(Tshak.."List:Rd:Sudo", text)
return send(msg_chat_id,msg_id,"• تم مسح الرد من الردود العامه","md",true)  
end
end
if Redis:get(Tshak.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender_id.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(Tshak.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender_id.user_id) 
return send(msg_chat_id,msg_id, "\n• تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(Tshak.."ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
bot.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(Tshak.."PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(Tshak.."PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
bot.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(Tshak.."PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
bot.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(Tshak.."PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
bot.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(Tshak.."PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
bot.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(Tshak.."PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
bot.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(Tshak.."PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
bot.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(Tshak.."PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
send(v,0,text,"html",true)
Redis:set(Tshak.."PinMsegees:"..v,text)
end
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Tshak.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender_id.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(Tshak.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender_id.user_id) 
return send(msg_chat_id,msg_id, "\n• تم الغاء الاذاعه خاص","md",true)  
end 
local list = Redis:smembers(Tshak..'Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
bot.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Tshak.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender_id.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(Tshak.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender_id.user_id) 
return send(msg_chat_id,msg_id, "\n• تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(Tshak.."ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Tshak.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender_id.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(Tshak.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender_id.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Tshak.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender_id.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(Tshak.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender_id.user_id) 
...
if text and Redis:get(Tshak..'GetTexting:DevTshak'..msg_chat_id..':'..msg.sender_id.user_id) then
if text == 'الغاء' or text == 'الغاء الامر •' then 
Redis:del(Tshak..'GetTexting:DevTshak'..msg_chat_id..':'..msg.sender_id.user_id)
return send(msg_chat_id,msg_id,'• تم الغاء حفظ كليشة المطور')
end
Redis:set(Tshak..'Texting:DevTshak',text)
Redis:del(Tshak..'GetTexting:DevTshak'..msg_chat_id..':'..msg.sender_id.user_id)
return send(msg_chat_id,msg_id,'• تم حفظ كليشة المطور')
end
if Redis:get(Tshak.."Redis:Id:Group"..msg.chat_id..""..msg.sender_id.user_id) then 
if text == 'الغاء' then 
send(msg_chat_id,msg_id, "\n• تم الغاء امر تعيين الايدي","md",true)  
Redis:del(Tshak.."Redis:Id:Group"..msg.chat_id..""..msg.sender_id.user_id) 
return false  
end 
Redis:del(Tshak.."Redis:Id:Group"..msg.chat_id..""..msg.sender_id.user_id) 
Redis:set(Tshak.."Set:Id:Group"..msg.chat_id,text:match("(.*)"))
send(msg_chat_id,msg_id,'• تم تعيين الايدي الجديد',"md",true)  
end
if Redis:get(Tshak.."Redis:Id:Groups"..msg.chat_id..""..msg.sender_id.user_id) then 
if text == 'الغاء' then 
send(msg_chat_id,msg_id, "\n• تم الغاء امر تعيين الايدي","md",true)  
Redis:del(Tshak.."Redis:Id:Groups"..msg.chat_id..""..msg.sender_id.user_id) 
return false  
end 
Redis:del(Tshak.."Redis:Id:Groups"..msg.chat_id..""..msg.sender_id.user_id) 
Redis:set(Tshak.."Set:Id:Groups",text:match("(.*)"))
send(msg_chat_id,msg_id,'• تم تعيين الايدي الجديد عام',"md",true)  
end
if Redis:get(Tshak.."Change:Name:Bot"..msg.sender_id.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(Tshak.."Change:Name:Bot"..msg.sender_id.user_id) 
return send(msg_chat_id,msg_id, "\n• تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(Tshak.."Change:Name:Bot"..msg.sender_id.user_id) 
Redis:set(Tshak.."Name:Bot",text) 
return send(msg_chat_id,msg_id, "• تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(Tshak.."Change:Start:Bot"..msg.sender_id.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(Tshak.."Change:Start:Bot"..msg.sender_id.user_id) 
return send(msg_chat_id,msg_id, "\n• تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(Tshak.."Change:Start:Bot"..msg.sender_id.user_id) 
Redis:set(Tshak.."Start:Bot",text) 
...
Redis:incrby(Tshak.."Num:Add:Games"..msg.chat_id..msg.sender_id.user_id,5)  
Redis:del(Tshak.."Games:Set:Answer"..msg.chat_id)
return send(msg.chat_id,msg.id,'*• الف مبروك اجابتك صحيحه تم اضافه لك 5 نقاط*')
end
end
if Redis:get(Tshak.."All:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id) == 'startdel' then
if not Redis:sismember(Tshak.."All:text:Games:Bot",text) then
send(msg_chat_id,msg_id,'• لا يوجد صوتيه بهذا الاسم في العامه')
Redis:del(Tshak.."All:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
return false
end
Redis:del(Tshak.."All:audio:Games"..text)
Redis:srem(Tshak.."All:text:Games:Bot",text)  
Redis:del(Tshak.."All:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
send(msg_chat_id,msg_id,'• تم مسح الصوتيه بنجاح')
return false
end

if Redis:get(Tshak.."All:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id) == 'start' then
Redis:set(Tshak..'All:Text:Games:audio'..msg.chat_id,text)
Redis:sadd(Tshak.."All:text:Games:Bot",text)  
Redis:set(Tshak.."All:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id,'started')
send(msg_chat_id,msg_id,'• الان ارسل الصوتيه ليتم حفظها باسم  : '..text)
return false
end
if Redis:get(Tshak.."All:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id) == 'started' then
if msg.content.audio then  
local nameaudio = Redis:get(Tshak..'All:Text:Games:audio'..msg.chat_id)
Redis:set(Tshak.."All:audio:Games"..nameaudio,msg.content.audio.audio.remote.id)  
Redis:del(Tshak.."All:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
...
local nameaudio = Redis:get(Tshak.."All:audio:Games"..text)
if nameaudio then
bot.sendAudio(msg_chat_id, msg.id,nameaudio , '', "md") 
end
end

if Redis:get(Tshak.."Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id) == 'startdel' then
if not Redis:sismember(Tshak.."text:Games:Bot"..msg.chat_id,text) then
send(msg_chat_id,msg_id,'• لا يوجد صوتيه بهذا الاسم في الجروب')
Redis:del(Tshak.."Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
return false
end
Redis:del(Tshak.."audio:Games"..msg.chat_id..text)
Redis:srem(Tshak.."text:Games:Bot"..msg.chat_id,text)  
Redis:del(Tshak.."Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
send(msg_chat_id,msg_id,'• تم مسح الصوتيه بنجاح')
return false
end
...
if Redis:get(Tshak.."Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id) == 'started' then
if msg.content.audio then  
local nameaudio = Redis:get(Tshak..'Text:Games:audio'..msg.chat_id)
Redis:set(Tshak.."audio:Games"..msg.chat_id..nameaudio,msg.content.audio.audio.remote.id)  
Redis:del(Tshak.."Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
send(msg_chat_id,msg_id,'• تم حفظ الصوتيه باسم : '..nameaudio)
return false
end   
...
local nameaudio = Redis:get(Tshak.."audio:Games"..msg.chat_id..text)
if nameaudio then
bot.sendAudio(msg_chat_id, msg.id,nameaudio , '', "md") 
end
end
...
Redis:set(Tshak.."kahzm"..msg.sender_id.user_id,"sendnumh") 
Text = 'ارسل لى الجمله لتعرف صدق ام كذب🌚✨'
return bot.sendText(msg_chat_id,msg_id,Text,"md",true) 
end
end
if text and Redis:get(Tshak.."kahzm"..msg.sender_id.user_id) == "sendnumh" then
...
Redis:del(Tshak.."kahzm"..msg.sender_id.user_id)
return false
end

if text then
local NewCmmd = Redis:get(Tshak.."All:Get:Reides:Commands:Group"..text) or Redis:get(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
text = (NewCmmd or text)
end
end
if Redis:get(Tshak.."Channel:Redis"..msg.sender_id.user_id) == "on" then
Redis:set(Tshak.."Channel:Redis"..msg.sender_id.user_id,"off")
...
Redis:del(Tshak.."Chat:Channel:Join")
Redis:set(Tshak.."Chat:Channel:Join",ch)
Redis:del(Tshak.."Channel:Join")
Redis:set(Tshak.."Channel:Join",data.result.invite_link)
else
...
Redis:set(Tshak..'Channel:Redis'..msg_chat_id..':'..senderr,true)
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Tshak..'All:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Tshak..'All:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'*\n• عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end
if ChannelJoin(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Tshak..'All:Channel:Join:Name'), url = 't.me/'..Redis:get(Tshak..'All:Channel:Join')}, },}}
return send(msg.chat_id,msg.id,'*\n• عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end
local list = Redis:smembers(Tshak.."All:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(Tshak.."All:Filter:Group:"..v)  
Redis:srem(Tshak.."All:List:Filter",v)  
end  
...
local list = Redis:smembers(Tshak.."All:List:Filter")  
if #list == 0 then  
return send(msg_chat_id,msg_id,"*• لا يوجد كلمات ممنوعه هنا *","md",true)   
end  
Filter = '\n*• قائمه المنع \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*\n'
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(Tshak.."All:Filter:Group:"..v)   
...
Redis:set(Tshak..'All:FilterText'..msg_chat_id..':'..msg.sender_id.user_id,'true')
...
Redis:set(Tshak..'All:FilterText'..msg_chat_id..':'..msg.sender_id.user_id,'DelFilterq')
return send(msg_chat_id,msg_id,'\n*• ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
if (Redis:get(Tshak..'All:FilterText'..msg_chat_id..':'..msg.sender_id.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(Tshak.."All:List:Filter",'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(Tshak.."All:Filter:Text"..msg.sender_id.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(Tshak.."All:List:Filter",'animation:'..msg.content.animation.animation.id)  
Redis:set(Tshak.."All:Filter:Text"..msg.sender_id.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(Tshak.."All:List:Filter",'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(Tshak.."All:Filter:Text"..msg.sender_id.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(Tshak.."All:Filter:Text"..msg.sender_id.user_id..':'..msg_chat_id, text)  
Redis:sadd(Tshak.."All:List:Filter",'text:'..text)  
Filters = 'نص'
end
Redis:set(Tshak..'All:FilterText'..msg_chat_id..':'..msg.sender_id.user_id,'true1')
return send(msg_chat_id,msg_id,"\n• ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(Tshak..'All:FilterText'..msg_chat_id..':'..msg.sender_id.user_id) == 'true1') then
local Text_Filter = Redis:get(Tshak.."All:Filter:Text"..msg.sender_id.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(Tshak.."All:Filter:Group:"..Text_Filter,text)  
end  
Redis:del(Tshak.."All:Filter:Text"..msg.sender_id.user_id..':'..msg_chat_id)  
Redis:del(Tshak..'All:FilterText'..msg_chat_id..':'..msg.sender_id.user_id)
return send(msg_chat_id,msg_id,"\n• تم اضافه رد التحذير","md",true)  
end
...
local ReplyFilters = Redis:get(Tshak.."All:Filter:Group:"..DelFilters)
if ReplyFilters and not msg.Special then
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
return send(msg_chat_id,msg_id,"*• لقد تم منع هذه ( "..statusfilter.." ) هنا*\n• "..ReplyFilters,"md",true)   
end
...
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Tshak..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Tshak..'Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'* ♡ عليك الاشتراك في قناة البوت لأستخدام الاوامر\n√*',"md",false, false, false, false, reply_markup)
end
if ChannelJoin(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Tshak..'Channel:Join:Name'), url = 't.me/'..Redis:get(Tshak..'Channel:Join')}, },}}
return send(msg.chat_id,msg.id,'* ♡ عليك الاشتراك في قناة البوت لأستخدام الاوامر\n√*',"md",false, false, false, false, reply_markup)
end
...
i = i + 1
Redis:sadd(Tshak.."Dev:Groups",v)  
end
x = 0
for k,v in pairs(FilesJson.devss) do
x = x + 1
Redis:sadd(Tshak.."Devss:Groups",v)  
end
...
Y = Y + 1
Redis:sadd(Tshak..'Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(Tshak.."ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(Tshak.."SuperCreator:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(Tshak.."Creator:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(Tshak.."Manger:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(Tshak.."Admin:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(Tshak.."Special:Group"..GroupId,v)
end
end 
end
...
Redis:sadd(Tshak.."ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(Tshak.."Creator:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(Tshak.."Manger:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(Tshak.."Admin:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(Tshak.."SuperCreator:Group"..idg,idASAS)
end;end
end
...
if (Redis:get(Tshak.."AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(Tshak.."AddSudosNew"..msg_chat_id)
...
Redis:set(Tshak.."AddSudosNew"..msg_chat_id,true)
...
download('http://45.32.238.150/Mero/Tshak.lua','Tshak.lua')
...
Redis:setex(Tshak..'welcom_ph:witting'..senderr,300,true) 
...
Redis:set(Tshak..'Num:Add:Bot',text:match("تعيين عدد الاعضاء (%d+)$") ) 
...
send(msg_chat_id,msg_id,'*• عدد احصائيات البوت الكامله \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n• عدد المجموعات : '..(Redis:scard(Tshak..'ChekBotAdd') or 0)..'\n• عدد المشتركين : '..(Redis:scard(Tshak..'Num:User:Pv') or 0)..'*',"md",true)  
end
if text == 'تفعيل' and msg.Dev then
if Redis:sismember(Tshak..'ban:online',msg.chat_id) then
...
Redis:sadd(Tshak.."ChekBotAdd",msg_chat_id)
Redis:set(Tshak..'lock_chengname'..msg.chat_id,true)  
Redis:set(Tshak.."Status:Games"..msg.chat_id,true) 
Redis:set(Tshak.."smsme"..msg.chat_id,true)
Redis:set(Tshak.."Status:IdPhoto"..msg.chat_id,true) 
Redis:set(Tshak.."Status:Id"..msg.chat_id,true) 
Redis:set(Tshak.."Status:ReplySudo"..msg.chat_id,true) 
Redis:set(Tshak.."Status:Reply"..msg.chat_id,true) 
Redis:set(Tshak.."Status:IdPhoto"..msg.chat_id,true) 
Redis:set(Tshak.."Status:Id"..msg.chat_id,true) 
Redis:set(Tshak.."Status:Welcome"..msg.chat_id,true) 
Redis:set(Tshak.."Status:Link"..msg.chat_id,true) 
Redis:set(Tshak.."Status:Games"..msg.chat_id,true) 
Redis:set(Tshak..'tagallgroup'..msg.chat_id,'open') 
Redis:set(Tshak..'tagall@all'..msg.chat_id,'open') 
Redis:del(Tshak.."knele"..msg.chat_id)
Redis:set(Tshak.."Status:Link"..msg.chat_id,true) 
Redis:set(Tshak.."Status:Welcome"..msg.chat_id,true) 
Redis:set(Tshak.."Status:BanId"..msg.chat_id,true) 
Redis:set(Tshak.."Status:ReplySudo"..msg.chat_id,true) 
Redis:set(Tshak.."Status:Reply"..msg.chat_id,true) 
Redis:set(Tshak.."Status:IdPhoto"..msg.chat_id,true) 
Redis:set(Tshak.."Status:Id"..msg.chat_id,true) 
Redis:set(Tshak.."Status:SetId"..msg.chat_id,true) 
Redis:set(Tshak.."Status:KickMe"..msg.chat_id,true) 
Redis:set(Tshak.."replayallbot"..msg.chat_id,true)
Redis:del(Tshak.."amrthshesh"..msg.chat_id)
Redis:del(Tshak.."spammkick"..msg.chat_id)
Redis:del(Tshak.."intg"..msg.chat_id)
Redis:del(Tshak.."kadmeat"..msg.chat_id)
Redis:del(Tshak.."zhrfa"..msg.chat_id)
Redis:del(Tshak.."brjj"..msg.chat_id)
Redis:del(Tshak.."idnotmembio"..msg.chat_id)
Redis:del(Tshak.."idnotmem"..msg.chat_id)
Redis:del(Tshak..'lock_geamsAudio1'..msg.chat_id) 
Redis:del(Tshak..'lock_geamsAudio'..msg.chat_id) 
Redis:del(Tshak.."Lock:tagservrbot"..msg.chat_id)   
...
Redis:del(Tshak..''..lock..msg.chat_id)    
end
local Get_Chat = bot.getChat(msg_chat_id)
local Info_Chats = bot.getSupergroupFullInfo(msg_chat_id)
if Redis:sismember(Tshak.."ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(Tshak..'Num:Add:Bot') or 0)) and not msg.Asasy then
return send(msg_chat_id,msg_id,'•عدد الاعضاء قليل لا يمكن تفعيل الجروب  يجب ان يكوم اكثر من :'..Redis:get(Tshak..'Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(Tshak.."ChekBotAdd",msg_chat_id)
Redis:set(Tshak.."Status:Id"..msg_chat_id,true) ;Redis:del(Tshak.."Status:Reply"..msg_chat_id) ;Redis:del(Tshak.."Status:ReplySudo"..msg_chat_id) ;Redis:set(Tshak.."Status:BanId"..msg_chat_id,true) ;Redis:set(Tshak.."Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(Tshak.."BotFree") then
...
local Get_Chat = bot.getChat(msg_chat_id)
local Info_Chats = bot.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(Tshak.."ChekBotAdd",msg_chat_id) then
...
Redis:srem(Tshak.."ChekBotAdd",msg_chat_id)
return send(msg_chat_id,msg_id,'\n*•الجروب : {*['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')*}\n• تم تعطيلها بنجاح *','md',true)
end
end
if chat_type(msg.chat_id) == "GroupBot" and not Redis:sismember(Tshak.."ChekBotAdd",msg_chat_id) then
Redis:sadd(Tshak.."ChekBotAdd",msg_chat_id)
Redis:set(Tshak..'lock_chengname'..msg.chat_id,true)  
Redis:set(Tshak.."Status:Games"..msg.chat_id,true) 
Redis:set(Tshak.."smsme"..msg.chat_id,true)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(Tshak.."ChekBotAdd",msg_chat_id) then

if text then
local GetMsg = Redis:incr(Tshak..'Num:Message:User'..msg.chat_id..':'..senderr) 
Redis:hset(Tshak..':GroupUserCountMsg:'..msg.chat_id,senderr,GetMsg)
...
NameLUser = NameLUser:gsub("[[]","")
Redis:hset(Tshak..':GroupNameUser:'..msg.chat_id,senderr,NameLUser)
end
...
GroupAllRtba = Redis:hgetall(Tshak..':GroupUserCountMsg:'..msg.chat_id)
GetAllNames  = Redis:hgetall(Tshak..':GroupNameUser:'..msg.chat_id)
GroupAllRtbaL = {}
...
if Redis:sismember(Tshak.."KtmAll:Groups",UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," •تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Tshak.."KtmAll:Groups",UserId_Info.id) 
...
if UserInfo and UserInfo.type and UserInfo.type.Tshakbots == "userTypeBot" then
...
local Info_Members = Redis:smembers(Tshak.."KtmAll:Groups") 
if #Info_Members == 0 then
return send(msg_chat_id,msg_id," •لا يوجد مكتومين عام حاليا , ","md",true)  
end
Redis:del(Tshak.."KtmAll:Groups") 
...
local name_parlo = bot.getUser(2100004938).first_name.." "..bot.getUser(2100004938).last_name
local caption = "اليك قائمه مطورين سورس قيصر :"
if tonumber(UserId_Info.id) ~= 2100004938 then
...
{
{text = name_parlo, data = msg.sender_id.user_id..'/DevShow@2100004938'},
},
LocalDev
,
{
...
--[[
if Redis:get(Tshak..'Set:array'..senderr..':'..msg_chat_id) == 'true1' then
text = text:gsub('"','') 
text = text:gsub("'",'') 
text = text:gsub('`','') 
text = text:gsub('*','') 
local test = Redis:get(Tshak..'Text:array'..senderr..':'..msg_chat_id..'')
Redis:sadd(Tshak.."Add:Rd:array:Text"..test,text)  
_key = {
...
if text then
if Redis:get(Tshak.."Set:array:Ssd"..senderr..":"..msg_chat_id) == 'dttd' then
Redis:del(Tshak.."Set:array:Ssd"..senderr..":"..msg_chat_id)
gery = Redis:get(Tshak.."Set:array:addpu"..senderr..":"..msg_chat_id)
if not Redis:sismember(Tshak.."Add:Rd:array:Text"..gery,text) then
send(msg_chat_id, msg_id,' * •لا يوجد رد متعدد * ',"md",true)
return false
end
Redis:srem(Tshak.."Add:Rd:array:Text"..gery,text)
send(msg_chat_id, msg_id,' * •تم حذفه بنجاح .* ',"md",true)
end
end
if text then
if Redis:get(Tshak.."Set:array:Ssd"..senderr..":"..msg_chat_id) == 'delrd' then
Redis:del(Tshak.."Set:array:Ssd"..senderr..":"..msg_chat_id)
if not Redis:sismember(Tshak..'List:array',text) then
send(msg_chat_id, msg_id,' * •لا يوجد رد متعدد * ',"md",true)
return false
end
Redis:set(Tshak.."Set:array:addpu"..senderr..":"..msg_chat_id,text)
Redis:set(Tshak.."Set:array:Ssd"..senderr..":"..msg_chat_id,"dttd")
...
Redis:set(Tshak.."Set:array:Ssd"..senderr..":"..msg_chat_id,"delrd")
return false 
end
if text then
if Redis:get(Tshak.."Set:array"..senderr..":"..msg_chat_id) == 'true' then
Redis:sadd(Tshak..'List:array', text)
Redis:set(Tshak..'Text:array'..senderr..':'..msg_chat_id, text)
send(msg_chat_id, msg_id,'ارسل الرد الذي تريد اضافته',"md",true)
Redis:del(Tshak.."Set:array"..senderr..":"..msg_chat_id)
Redis:set(Tshak..'Set:array'..senderr..':'..msg_chat_id,'true1')
Redis:del(Tshak.."Add:Rd:array:Text"..text)   
return false
end
end

if text then
if Redis:get(Tshak.."Set:array:rd"..senderr..":"..msg_chat_id) == 'delrd' then
Redis:del(Tshak.."Set:array:rd"..senderr..":"..msg_chat_id)
Redis:del(Tshak.."Add:Rd:array:Text"..text)
Redis:srem(Tshak..'List:array', text)
...
send_inlin_key(msg_chat_id,"• ارسل الكلمه التي تريد حذفها",inlin,msg_id)
Redis:set(Tshak.."Set:array:rd"..senderr..":"..msg_chat_id,"delrd")
return false 
end
if text then
if  Redis:sismember(Tshak..'List:array',text) then
local list = Redis:smembers(Tshak.."Add:Rd:array:Text"..text)
...
local list = Redis:smembers(Tshak..'List:array')
...
local list = Redis:smembers(Tshak..'List:array')
for k,v in pairs(list) do
Redis:del(Tshak.."Add:Rd:array:Text"..v..msg_chat_id)   
Redis:del(Tshak..'List:array'..msg_chat_id)
end
...
Redis:set(Tshak.."Set:array"..senderr..":"..msg_chat_id,true)
return false
end
]]
--=> multi reply
...
text = text:gsub('`','') 
text = text:gsub('*','')
Redis:set(Tshak.."media:type:"..text, "text")
Redis:sadd(Tshak.."Add:Rd:array:Text"..test,text)
end
if msg.content.sticker then
Redis:set(Tshak.."media:type:"..msg.content.sticker.sticker.remote.id, "sticker")
Redis:sadd(Tshak.."Add:Rd:array:Text"..test,msg.content.sticker.sticker.remote.id)
end   
if msg.content.voice_note then
Redis:set(Tshak.."media:type:"..msg.content.voice_note.voice.remote.id, "voice_note")
Redis:sadd(Tshak.."Add:Rd:array:Text"..test, msg.content.voice_note.voice.remote.id)
end
if msg.content.audio then
Redis:set(Tshak.."media:type:"..msg.content.audio.audio.remote.id, "audio")
Redis:sadd(Tshak.."Add:Rd:array:Text"..test, msg.content.audio.audio.remote.id)
end
if msg.content.document then
Redis:set(Tshak.."media:type:"..msg.content.document.document.remote.id, "document")
Redis:sadd(Tshak.."Add:Rd:array:Text"..test, msg.content.document.document.remote.id)
end
if msg.content.animation then
Redis:set(Tshak.."media:type:"..msg.content.animation.animation.remote.id, "animation")
Redis:sadd(Tshak.."Add:Rd:array:Text"..test, msg.content.animation.animation.remote.id)
end
if msg.content.video_note then
Redis:set(Tshak.."media:type:"..msg.content.video_note.video.remote.id, "video_note")
Redis:sadd(Tshak.."Add:Rd:array:Text"..test, msg.content.video_note.video.remote.id)
end
if msg.content.video then
Redis:set(Tshak.."media:type:"..msg.content.video.video.remote.id, "video")
Redis:sadd(Tshak.."Add:Rd:array:Text"..test, msg.content.video.video.remote.id)
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(Tshak.."media:type:"..idPhoto, "photo")
Redis:sadd(Tshak.."Add:Rd:array:Text"..test, idPhoto)
end
_key = {
{{text="اضغط هنا لانهاء الاضافه",callback_data="EndAddarray"..senderr}},
}
...
if Redis:get(Tshak.."media:type:"..rd) == "text" then
send(msg_chat_id, msg_id,'['..rd..']',"md",true)
elseif Redis:get(Tshak.."media:type:"..rd) == "sticker" then
bot.sendSticker(msg_chat_id, msg.id, rd)
elseif Redis:get(Tshak.."media:type:"..rd) == "voice_note" then
bot.sendVoiceNote(msg_chat_id, msg.id, rd, '', 'md')
elseif Redis:get(Tshak.."media:type:"..rd) == "audio" then
bot.sendAudio(msg_chat_id, msg.id, rd, '', "md") 
elseif Redis:get(Tshak.."media:type:"..rd) == "document" then
bot.sendDocument(msg_chat_id, msg.id, rd, '', 'md')
elseif Redis:get(Tshak.."media:type:"..rd) == "animation" then
bot.sendAnimation(msg_chat_id,msg.id, rd, '', 'md')
elseif Redis:get(Tshak.."media:type:"..rd) == "video_note" then
bot.sendVideoNote(msg_chat_id, msg.id, rd)
elseif Redis:get(Tshak.."media:type:"..rd) == "video" then
bot.sendVideo(msg_chat_id, msg.id, rd, '', "md")
elseif Redis:get(Tshak.."media:type:"..rd) == "photo" then
...
local list = Redis:smembers(Tshak..'List:array')
for k,v in pairs(list) do
Redis:del(Tshak.."Add:Rd:array:Text"..v)   
Redis:del(Tshak..'List:array')
end
send(msg_chat_id, msg_id," * ⌔تم مسح الردود المتعدده*","md",true)
end
if text == "اضف رد متعدد" then   
...
local list = Redis:smembers(Tshak.."meza:names:")
if #list == 0 then
return send(msg.chat_id, msg.id,"لايوجد مميزات.", 'md')
end
local Text_Msg = "المميزات :\n\n"
for k,v in pairs(list) do
local link = Redis:get(Tshak.."meza:link"..v)
local type = Redis:get(Tshak.."meza:type"..v)
...
for k,v in pairs(list) do
Redis:del(Tshak.."meza:type"..v)
Redis:del(Tshak.."meza:link"..v)
end
Redis:del(Tshak.."meza:names:")
...
Redis:set(Tshak.."add_meza:send:"..msg.chat_id..":"..msg.sender_id.user_id, true)
...
Redis:set(Tshak.."add_meza:rem:"..msg.chat_id..":"..msg.sender_id.user_id, true)
return send(msg.chat_id, msg.id,"ارسل اسم الميزه :", 'md')
end

if text and Redis:get(Tshak.."add_meza:rem:"..msg.chat_id..":"..msg.sender_id.user_id) == "true" then
if Redis:get(Tshak.."meza:type"..text) then
Redis:del(Tshak.."meza:type"..text)
Redis:del(Tshak.."meza:link"..text)
Redis:del(Tshak.."add_meza:rem:"..msg.chat_id..":"..msg.sender_id.user_id)
Redis:srem(Tshak.."meza:names:", text)
...
if text and Redis:get(Tshak.."add_meza:send:"..msg.chat_id..":"..msg.sender_id.user_id) == "true" then
Redis:set(Tshak.."add_meza:send:"..msg.chat_id..":"..msg.sender_id.user_id, "link")
Redis:set(Tshak.."add_meza:name:"..msg.chat_id..":"..msg.sender_id.user_id, text)
return send(msg.chat_id, msg.id,"تم حفظ الاسم بنجاح \nارسل الرابط الان :", 'md')
end

if text and Redis:get(Tshak.."add_meza:send:"..msg.chat_id..":"..msg.sender_id.user_id) == "link" then
...
Redis:del(Tshak.."add_meza:send:"..msg.chat_id..":"..msg.sender_id.user_id)
local meza_name = Redis:get(Tshak.."add_meza:name:"..msg.chat_id..":"..msg.sender_id.user_id)
Redis:set(Tshak.."meza:link"..meza_name, text)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
---
if text and Redis:get(Tshak.."meza:type"..text) then
local meza_link = Redis:get(Tshak.."meza:link"..text)
...
local meza_type = Redis:get(Tshak.."meza:type"..text)
...
-- 7azer
if text == "حزر" then
if Redis:get(Tshak..":7azer:"..msg_chat_id) then
local time = ctime(tonumber(Redis:ttl(Tshak..":7azer:"..msg_chat_id)))
local Userid = tonumber(Redis:get(Tshak..":7azer:"..msg_chat_id))
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
Redis:setex(Tshak..":7azer:"..msg_chat_id, 180, msg.sender_id.user_id)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if text and text ~= "حزر" and Redis:get(Tshak..":7azer:"..msg_chat_id) then
local ttl_time = tonumber(Redis:ttl(Tshak..":7azer:"..msg_chat_id))
local time = ctime(ttl_time)
local Game_king = Redis:get(Tshak..":7azer:"..msg_chat_id)
if Redis:sismember(Tshak..":7azer:mem:"..msg_chat_id, msg.sender_id.user_id) then
local answer = Redis:get(Tshak..":7azer:answer"..msg_chat_id)
if text == answer and tonumber(msg.sender_id.user_id) ~= tonumber(Game_king) then
Redis:del(Tshak..":7azer:mem:"..msg_chat_id)
Redis:del(Tshak..":7azer:"..msg_chat_id)
Redis:del(Tshak..":7azer:chat_id"..Game_king)
Redis:del(Tshak..":7azer:quiz"..msg_chat_id)
Redis:del(Tshak..":7azer:answer"..msg_chat_id)
...
-- my rd
if text and Redis:get(Tshak..":My_Rd:set:"..msg.sender_id.user_id..":"..msg.chat_id) then
if Redis:sismember(Tshak..":My_Rd:text:"..msg.chat_id, text) then
return send(msg.chat_id, msg.id, "يوجد رد بهذا الاسم مسبقا", 'md')
end
Redis:sadd(Tshak..":My_Rd:text:"..msg.chat_id, text)
Redis:set(Tshak..":My_Rd:"..text..":"..msg.chat_id, msg.sender_id.user_id)
Redis:incrby(Tshak..":My_Rd:num"..msg.sender_id.user_id..":"..msg.chat_id, 1)
Redis:del(Tshak..":My_Rd:set:"..msg.sender_id.user_id..":"..msg.chat_id)
return send(msg.chat_id, msg.id, "تم اضافه رد اليك بنجاح", 'md')
end

if text == "اضف ردي" and not Redis:get(Tshak..":My_Rd:lock:"..msg.chat_id) then
local Num = Redis:get(Tshak..":My_Rd:num"..msg.sender_id.user_id..":"..msg.chat_id)
if tonumber(Num) == 2 then 
return send(msg.chat_id, msg.id, "لديك ردين باسمك فعلا ولايمكن الزياده.", 'md')
end
Redis:set(Tshak..":My_Rd:set:"..msg.sender_id.user_id..":"..msg.chat_id, true)
send(msg.chat_id, msg.id, "ارسل اسم الرد الان :", 'md')
end

if text and Redis:get(Tshak..":My_Rd:del:"..msg.sender_id.user_id..":"..msg.chat_id) then
if not Redis:sismember(Tshak..":My_Rd:text:"..msg.chat_id, text) then
return send(msg.chat_id, msg.id, "لايوجد ردود بهذا الاسم", 'md')
end
if not tonumber(Redis:get(Tshak..":My_Rd:"..text..":"..msg.chat_id)) == tonumber(msg.sender_id.user_id) and not msg.Owners then
return send(msg.chat_id, msg.id, "هذا الرد لايخصك", 'md')
end
Redis:del(Tshak..":My_Rd:"..text..":"..msg.chat_id)
Redis:srem(Tshak..":My_Rd:text:"..msg.chat_id, text)
Redis:decrby(Tshak..":My_Rd:num"..msg.sender_id.user_id..":"..msg.chat_id, 1)
Redis:del(Tshak..":My_Rd:del:"..msg.sender_id.user_id..":"..msg.chat_id)
send(msg.chat_id, msg.id, "تم حذف ردك بنجاح", 'md')
end

if text == "حذف ردودي" and not Redis:get(Tshak..":My_Rd:lock:"..msg.chat_id) then
local list = Redis:smembers(Tshak..":My_Rd:text:"..msg.chat_id)
for k,v in pairs(list) do
if tonumber(Redis:get(Tshak..":My_Rd:"..v)) == tonumber(msg.sender_id.user_id)then
Redis:del(Tshak..":My_Rd:"..v..":"..msg.chat_id)
Redis:srem(Tshak..":My_Rd:text:"..msg.chat_id, v)
Redis:decrby(Tshak..":My_Rd:num"..msg.sender_id.user_id..":"..msg.chat_id, 1)
end
end
...
if text == "حذف قائمه الردود" and not Redis:get(Tshak..":My_Rd:lock:"..msg.chat_id) then
local StatusMember = bot.getChatMember(msg.chat_id, msg.sender_id.user_id).status.Tshakbots
if not msg.Creator or not StatusMember == "chatMemberStatusCreator" then
return send(msg_chat_id,msg_id,'\n*⌯ هذا الامر يخص { مالك المجموعه او رتبه المنشئ }* ',"md",true)
end
local list = Redis:smembers(Tshak..":My_Rd:text:"..msg.chat_id)
for k,v in pairs(list) do
Redis:del(Tshak..":My_Rd:"..v)
Redis:srem(Tshak..":My_Rd:text:"..msg.chat_id, v)
local id = Redis:get(Tshak..":My_Rd:"..v..":"..msg.chat_id)
Redis:decrby(Tshak..":My_Rd:num"..id..":"..msg.chat_id, 1)
end
return send(msg.chat_id, msg.id, "مسحت الردود", 'md')
end

if text == "حذف ردي" and not Redis:get(Tshak..":My_Rd:lock:"..msg.chat_id) then
local Num = Redis:get(Tshak..":My_Rd:num"..msg.sender_id.user_id..":"..msg.chat_id)
if not Num then 
return send(msg.chat_id, msg.id, "انت لا تمتلك ردود", 'md')
end
Redis:set(Tshak..":My_Rd:del:"..msg.sender_id.user_id..":"..msg.chat_id, true)
send(msg.chat_id, msg.id, "ارسل اسم الرد الان :", 'md')
end

if text and  Redis:sismember(Tshak..":My_Rd:text:"..msg.chat_id, text) and not Redis:get(Tshak..":My_Rd:lock:"..msg.chat_id) then 
local ID = Redis:get(Tshak..":My_Rd:"..text..":"..msg.chat_id)
...
Redis:del(Tshak..":My_Rd:lock:"..msg.chat_id)
...
Redis:set(Tshak..":My_Rd:lock:"..msg.chat_id, true)
...
local emo =  Redis:get(Tshak.."like:id:emo:"..msg.chat_id) or '🤍'
if not Redis:get(Tshak.."like:id:"..msg.chat_id) then
return send(msg_chat_id,msg_id,'\n*•  اللايك ايدي مفعل مسبقا*',"md",true) 
end
Redis:del(Tshak.."like:id:"..msg.chat_id)
...
local emo =  Redis:get(Tshak.."like:id:emo:"..msg.chat_id) or '🤍'
if Redis:get(Tshak.."like:id:"..msg.chat_id) then
return send(msg_chat_id,msg_id,'\n*•  اللايك ايدي معطل مسبقا*',"md",true) 
end
Redis:set(Tshak.."like:id:"..msg.chat_id, true)
...
Redis:set(Tshak.."like:id:emo:"..msg.chat_id, emo)
...
local id_users = Redis:smembers(Tshak.."like:user:")
if #id_users <= 0 then
return send(msg_chat_id,msg_id,'\n•  لا يوجد مستخدمين',"md",true) 
end
for k,v in pairs(id_users) do
Redis:del(Tshak.."like:users:"..v)
end
Redis:del(Tshak.."like:user:")
...
for k,v in pairs(id_users) do
local likes = #Redis:smembers(Tshak.."like:users:"..v)
...
if not Redis:get(Tshak.."add:lock"..msg.chat_id) then
Redis:set(Tshak.."add:send:"..msg.chat_id..":"..msg.sender_id.user_id, true)
return send(msg.chat_id, msg.id,"ارسل الرابط الان", 'md')
end
end

if text and Redis:get(Tshak.."add:send:"..msg.chat_id..":"..msg.sender_id.user_id) then
local api = https.request("https://www.ava-tar.online/api/seen/add/index.php?link="..URL.escape(text))
local api_decode = JSON.decode(api)
Redis:del(Tshak.."add:send:"..msg.chat_id..":"..msg.sender_id.user_id)
send(msg.chat_id, msg.id,api,"html",true)
end


if text and text:match("^برج (.*)$") and not Redis:get(Tshak.."brjj"..msg.chat_id) then
...
if not Redis:get(Tshak..'mynames'..msg.chat_id)  then
...
if not Redis:get(Tshak.."Age:lock"..msg.chat_id) then
Redis:set(Tshak.."Age:send:"..msg.chat_id..":"..msg.sender_id.user_id, true)
return send(msg.chat_id, msg.id,"ارسل عمرك بالصيغيه التاليه :\n20/2/2002 يعني ( يوم/شهر/سنه )", 'md')
end
end

if text and Redis:get(Tshak.."Age:send:"..msg.chat_id..":"..msg.sender_id.user_id) then
...
Redis:del(Tshak.."Age:send:"..msg.chat_id..":"..msg.sender_id.user_id)
...
if text == "حذف قسم" then
  ...
  Redis:set(Tshak.."Set:Sections:inline"..msg.sender_id.user_id..":"..msg_chat_id,"true2")
  return send(msg_chat_id,msg_id,"• ارسل الان الكلمه لحذفها من الاقسام","md",false, false, false, false, reply_markup)
  end 
  if text and text:match("^(.*)$") then
  if Redis:get(Tshak.."Set:Sections:inline"..msg.sender_id.user_id..":"..msg_chat_id.."") == "true2" then
  Redis:del(Tshak.."Add:Sections:Text:inline"..text)   
  Redis:del(Tshak.."Sections:inline:text"..text)
  Redis:del(Tshak.."Sections:inline:link"..text)
  Redis:del(Tshak.."Set:Sections:inline"..msg.sender_id.user_id..":"..msg_chat_id.."")
  Redis:srem(Tshak.."List:Sections:inline", text)
  ...
  local list = Redis:smembers(Tshak.."List:Sections:inline")
  for k,v in pairs(list) do   
  Redis:del(Tshak.."Add:Sections:Text:inline"..v)   
  Redis:del(Tshak.."Sections:inline:v"..v)
  Redis:del(Tshak.."Sections:inline:link"..v)
  end
  Redis:del(Tshak.."List:Sections:inline")
  ...
  Redis:set(Tshak.."Set:Sections:inline"..msg.sender_id.user_id..":"..msg_chat_id,true)
  local reply_markup = bot.replyMarkup{
      type = 'inline',
      data = {
      {
  ...
  if text and text:match("^(.*)$") and tonumber(msg.sender_id.user_id) ~= tonumber(Tshak) then
  if Redis:get(Tshak.."Set:Sections:inline"..msg.sender_id.user_id..":"..msg_chat_id) == "true" then
  Redis:set(Tshak.."Set:Sections:inline"..msg.sender_id.user_id..":"..msg_chat_id,"true1")
  Redis:set(Tshak.."Text:Sections:inline"..msg.sender_id.user_id..":"..msg_chat_id, text)    
  Redis:del(Tshak.."Add:Sections:Text:inline"..text)   
  Redis:del(Tshak.."Sections:inline:text"..text)
  Redis:sadd(Tshak.."List:Sections:inline", text)
  send(msg_chat_id,msg_id,[[
...
if Redis:get(Tshak.."Set:Sections:inline"..msg.sender_id.user_id..":"..msg_chat_id) == "true1" and tonumber(msg.sender_id.user_id) ~= tonumber(Tshak) then
Redis:del(Tshak.."Set:Sections:inline"..msg.sender_id.user_id..":"..msg_chat_id)
Redis:set(Tshak.."Set:Sections:inline"..msg.sender_id.user_id..":"..msg_chat_id,"set_inline")
local anubis = Redis:get(Tshak.."Text:Sections:inline"..msg.sender_id.user_id..":"..msg_chat_id)
if msg.content.text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","")
Redis:set(Tshak.."Add:Sections:Text:inline"..anubis, text)
Redis:set(Tshak.."Add:Sections:Text:Type"..anubis, "text")
elseif msg.content.audio then
Redis:set(Tshak.."Add:Sections:Text:Type"..anubis, "audio")
Redis:set(Tshak.."Add:Sections:Text:inline"..anubis, msg.content.audio.audio.remote.id)
Redis:set(Tshak.."Add:Sections:Caption:inline"..anubis, msg.content.caption.text)
elseif msg.content.document then
Redis:set(Tshak.."Add:Sections:Text:Type"..anubis, "document")
Redis:set(Tshak.."Add:Sections:Text:inline"..anubis, msg.content.document.document.remote.id)
Redis:set(Tshak.."Add:Sections:Caption:inline"..anubis, msg.content.caption.text)
elseif msg.content.animation then
Redis:set(Tshak.."Add:Sections:Text:Type"..anubis, "animation")
Redis:set(Tshak.."Add:Sections:Text:inline"..anubis, msg.content.animation.animation.remote.id)
Redis:set(Tshak.."Add:Sections:Caption:inline"..anubis, msg.content.caption.text)
elseif msg.content.video then
Redis:set(Tshak.."Add:Sections:Text:Type"..anubis, "video")
Redis:set(Tshak.."Add:Sections:Text:inline"..anubis, msg.content.video.video.remote.id)
Redis:set(Tshak.."Add:Sections:Caption:inline"..anubis, msg.content.caption.text)
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(Tshak.."Add:Sections:Text:Type"..anubis, "photo")
Redis:set(Tshak.."Add:Sections:Text:inline"..anubis, idPhoto)
Redis:set(Tshak.."Add:Sections:Caption:inline"..anubis, msg.content.caption.text)
end
...
if text and Redis:get(Tshak.."Set:Sections:inline"..msg.sender_id.user_id..":"..msg_chat_id) == "set_inline" then
Redis:set(Tshak.."Set:Sections:inline"..msg.sender_id.user_id..":"..msg_chat_id, "set_link")
Redis:del(Tshak.."Sections:inline:help"..msg.sender_id.user_id..":"..msg_chat_id)
local anubis = Redis:get(Tshak.."Text:Sections:inline"..msg.sender_id.user_id..":"..msg_chat_id)
Redis:sadd(Tshak.."Sections:inline:text"..anubis, text)
Redis:set(Tshak.."Sections:inline:help"..msg.sender_id.user_id..":"..msg_chat_id, text)
send(msg_chat_id,msg_id,"※︙ الان ارسل محتوي الزر \n※︙ارسل نص او ميديا او رابط فقط حيث يظر عند ضغط العضو عليه","md",true)  
return false  
end

if Redis:get(Tshak.."Set:Sections:inline"..msg.sender_id.user_id..":"..msg_chat_id) == "set_link" then
local anubis = Redis:get(Tshak.."Text:Sections:inline"..msg.sender_id.user_id..":"..msg_chat_id)
local anubis_rand = math.random(1,999999999999)
local anubiss = Redis:get(Tshak.."Sections:inline:help"..msg.sender_id.user_id..":"..msg_chat_id)
local reply_markup = bot.replyMarkup{
        type = 'inline',
        data = {
        {
...
if msg.content.text and Redis:get(Tshak.."Add:Sections:Text:Type"..anubis) == "text" then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","")
Redis:set(Tshak.."/Anubis/"..anubis_rand, text)
Redis:set(Tshak.."Button:Sections:Text:Type"..anubis_rand, "text")
elseif msg.content.audio and Redis:get(Tshak.."Add:Sections:Text:Type"..anubis) ~= "text" then
Redis:set(Tshak.."Button:Sections:Text:Type"..anubis_rand, "audio")
Redis:set(Tshak.."/Anubis/"..anubis_rand, msg.content.audio.audio.remote.id)
Redis:set(Tshak.."/Anubis/Caption"..anubis_rand, msg.content.caption.text)
elseif msg.content.document and Redis:get(Tshak.."Add:Sections:Text:Type"..anubis) ~= "text" then
Redis:set(Tshak.."Button:Sections:Text:Type"..anubis_rand, "document")
Redis:set(Tshak.."/Anubis/"..anubis_rand, msg.content.document.document.remote.id)
Redis:set(Tshak.."/Anubis/Caption"..anubis_rand, msg.content.caption.text)
elseif msg.content.animation and Redis:get(Tshak.."Add:Sections:Text:Type"..anubis) ~= "text" then
Redis:set(Tshak.."Button:Sections:Text:Type"..anubis_rand, "animation")
Redis:set(Tshak.."/Anubis/"..anubis_rand, msg.content.animation.animation.remote.id)
Redis:set(Tshak.."/Anubis/Caption"..anubis_rand, msg.content.caption.text)
elseif msg.content.video and Redis:get(Tshak.."Add:Sections:Text:Type"..anubis) ~= "text" then
Redis:set(Tshak.."Button:Sections:Text:Type"..anubis_rand, "video")
Redis:set(Tshak.."/Anubis/"..anubis_rand, msg.content.video.video.remote.id)
Redis:set(Tshak.."/Anubis/Caption"..anubis_rand, msg.content.caption.text)
elseif msg.content.photo and Redis:get(Tshak.."Add:Sections:Text:Type"..anubis) ~= "text" then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
idPhoto = msg.content.photo.sizes[2].photo.remote.id
...
Redis:set(Tshak.."Button:Sections:Text:Type"..anubis_rand, "photo")
Redis:set(Tshak.."/Anubis/"..anubis_rand, idPhoto)
Redis:set(Tshak.."/Anubis/Caption"..anubis_rand, msg.content.caption.text)
else
return send(msg_chat_id,msg_id,"• احنا قولنا هتحط ميديا يبقا كلو ميديا هتحط نص يبقا كلو نص","md")  
end
Redis:set(Tshak.."Set:Sections:inline"..msg.sender_id.user_id..":"..msg_chat_id, "set_inline")
Redis:set(Tshak.."in_inline_button:"..anubiss, "/Anubis/"..anubis_rand)
...
if text and Redis:get(Tshak.."Add:Sections:Text:inline"..text) then
local button = Redis:smembers(Tshak.."Sections:inline:text"..text)    
local inline_anubis = {data = {}}
for k,v in pairs(button) do
inline_anubis[k] = {{text = v , data = msg.sender_id.user_id..Redis:get(Tshak.."in_inline_button:"..v).."&"..text}}
end
local reply_markup = bot.replyMarkup{
type = 'inline',
data = inline_anubis
}
if Redis:get(Tshak.."Add:Sections:Text:Type"..text) == "text" then
local Texingt = Redis:get(Tshak.."Add:Sections:Text:inline"..text)
local UserInfo = bot.getUser(msg.sender_id.user_id)
local Status_Gps = msg.Name_Controller
local Texingt = Texingt:gsub('#username',(UserInfo.username or 'لا يوجد')) 
...
elseif Redis:get(Tshak.."Add:Sections:Text:Type"..text) == "audio" then
local media = Redis:get(Tshak.."Add:Sections:Text:inline"..text)
local caption = Redis:get(Tshak.."Add:Sections:Caption:inline"..text)
bot.sendAudio(msg_chat_id, msg.id, media,caption, "md", nil, nil, nil, nil, nil, nil, nil, nil,reply_markup)
elseif Redis:get(Tshak.."Add:Sections:Text:Type"..text) == "document" then
local media = Redis:get(Tshak.."Add:Sections:Text:inline"..text)
local caption = Redis:get(Tshak.."Add:Sections:Caption:inline"..text)
bot.sendDocument(msg_chat_id, msg.id, media, caption, 'md',nil, nil, nil, nil,nil, reply_markup)
elseif Redis:get(Tshak.."Add:Sections:Text:Type"..text) == "animation" then
local media = Redis:get(Tshak.."Add:Sections:Text:inline"..text)
local caption = Redis:get(Tshak.."Add:Sections:Caption:inline"..text)
bot.sendAnimation(msg_chat_id,msg.id, media, caption, 'md', nil, nil, nil, nil, nil, nil, nil, nil,reply_markup)
elseif Redis:get(Tshak.."Add:Sections:Text:Type"..text) == "video" then
local media = Redis:get(Tshak.."Add:Sections:Text:inline"..text)
local caption = Redis:get(Tshak.."Add:Sections:Caption:inline"..text)
bot.sendVideo(msg_chat_id, msg.id, media, caption, "md", true, nil, nil, nil, nil, nil, nil, nil, nil, nil, reply_markup)
elseif Redis:get(Tshak.."Add:Sections:Text:Type"..text) == "photo" then
local media = Redis:get(Tshak.."Add:Sections:Text:inline"..text)
local caption = Redis:get(Tshak.."Add:Sections:Caption:inline"..text)
...
local StatusMember = bot.getChatMember(msg_chat_id,senderr).status.Tshakbots
if (StatusMember == "chatMemberStatusCreator") then
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
local StatusMember = bot.getChatMember(msg_chat_id,rep_idd).status.Tshakbots
if (StatusMember == "chatMemberStatusCreator") then
return send(msg_chat_id,msg_id,"• الصلاحيات : مالك الجروب","md",true) 
elseif (StatusMember == "chatMemberStatusAdministrator") then
StatusMemberChat = 'مشرف الجروب'
...
local StatusMember = bot.getChatMember(msg_chat_id,UserId_Info.id).status.Tshakbots
if (StatusMember == "chatMemberStatusCreator") then
return send(msg_chat_id,msg_id,"• الصلاحيات : مالك الجروب","md",true) 
elseif (StatusMember == "chatMemberStatusAdministrator") then
StatusMemberChat = 'مشرف الجروب'
...
TotalMsg = Redis:get(Tshak..'Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
TotalMsg = Redis:get(Tshak..'Num:Message:User'..msg_chat_id..':'..rep_idd) or 0
TotalMsgT = Total_message(TotalMsg) 
return send(msg_chat_id,msg_id,"• التفاعل : "..TotalMsgT, "md")
end
...
local RinkBot = Redis:get(Tshak..':SetRt'..msg.chat_id..':'..UserId_Info.id) or Controller(msg_chat_id,UserId_Info.id)
return send(msg_chat_id,msg_id,"• الرتبه : "..RinkBot, "md")
end
if text == 'الرتبه' and msg.reply_to_message_id ~= 0 then
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
local RinkBot = Redis:get(Tshak..':SetRt'..msg.chat_id..':'..rep_idd) or Controller(msg_chat_id,rep_idd)
return send(msg_chat_id,msg_id,"• الرتبه : "..RinkBot, "md")
end
if text =='رقمي' then
local UserInfo = bot.getUser(senderr)
...
if Message_Reply.Tshakbots == "error" then
...
if not Redis:get(Tshak.."Status:Id"..msg_chat_id) then
return false
end
if not Redis:get(Tshak.."like:id:"..msg.chat_id) then
if not Redis:sismember(Tshak.."like:user:", msg.sender_id.user_id) then
Redis:sadd(Tshak.."like:user:", msg.sender_id.user_id)
end
local like_num = Redis:smembers(Tshak.."like:users:"..msg.sender_id.user_id)
local emo =  Redis:get(Tshak.."like:id:emo:"..msg.chat_id) or '🤍'
...
local TotalMsg = Redis:get(Tshak..'Num:Message:User'..msg_chat_id..':'..senderr) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(Tshak..'Num:Message:Edit'..msg_chat_id..senderr) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(Tshak.."Num:Add:Games"..msg.chat_id..senderr) or 0
local NumAdd = Redis:get(Tshak.."Num:Add:Memp"..msg.chat_id..":"..senderr) or 0
...
Get_Is_Id = Redis:get(Tshak.."Set:Id:Groups") or Redis:get(Tshak.."Set:Id:Group"..msg_chat_id)
if Redis:get(Tshak.."Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
SuperCreator = Redis:sismember(Tshak.."SuperCreator:Group"..msg.chat_id,UserId_Info.id) 
Creator = Redis:sismember(Tshak.."Creator:Group"..msg.chat_id,UserId_Info.id)
Manger = Redis:sismember(Tshak.."Manger:Group"..msg.chat_id,UserId_Info.id)
Admin = Redis:sismember(Tshak.."Admin:Group"..msg.chat_id,UserId_Info.id)
Special = Redis:sismember(Tshak.."Special:Group"..msg.chat_id,UserId_Info.id)
BanGroup = Redis:sismember(Tshak.."BanGroup:Group"..msg.chat_id,UserId_Info.id)
SilentGroup = Redis:sismember(Tshak.."SilentGroup:Group"..msg.chat_id,UserId_Info.id)
if BanGroup then
BanGroupz = "✔"
else
BanGroupz = "❌"
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
SuperCreator = Redis:sismember(Tshak.."SuperCreator:Group"..msg.chat_id,rep_idd) 
Creator = Redis:sismember(Tshak.."Creator:Group"..msg.chat_id,rep_idd)
Manger = Redis:sismember(Tshak.."Manger:Group"..msg.chat_id,rep_idd)
Admin = Redis:sismember(Tshak.."Admin:Group"..msg.chat_id,rep_idd)
Special = Redis:sismember(Tshak.."Special:Group"..msg.chat_id,rep_idd)
BanGroup = Redis:sismember(Tshak.."BanGroup:Group"..msg.chat_id,rep_idd)
SilentGroup = Redis:sismember(Tshak.."SilentGroup:Group"..msg.chat_id,rep_idd)
if BanGroup then
BanGroupz = "✔"
else
BanGroupz = "❌"
...
local RinkBot = Redis:get(Tshak..':SetRt'..msg.chat_id..':'..UserId) or Controller(msg_chat_id,rep_idd)
local TotalMsg = Redis:get(Tshak..'Num:Message:User'..msg_chat_id..':'..rep_idd) or 0
local TotalEdit = Redis:get(Tshak..'Num:Message:Edit'..msg_chat_id..rep_idd) or 0
local TotalMsgT = Total_message(TotalMsg) 
if Redis:get(Tshak.."Status:IdPhoto"..msg_chat_id) then
if photo.total_count > 0 then
if not msg.Special and Redis:get(Tshak..'idnotmem'..msg.chat_id)  then
return send(msg_chat_id,msg_id,
'\n*• ايديك : ❪'..UserId..
...
local RinkBot = Redis:get(Tshak..':SetRt'..msg.chat_id..':'..UserId) or Controller(msg_chat_id,UserId)
local TotalMsg = Redis:get(Tshak..'Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(Tshak..'Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(Tshak.."Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(Tshak.."Num:Add:Games"..msg.chat_id..UserId) or 0
if UserInfo.Tshakbots  == "error" and UserInfo.code == 6 then
return send(msg_chat_id,msg_id,"\n• عذرآ لا تستطيع استخدام ايدي خطأ ","md",true)  
end 
return send(msg_chat_id,msg_id,
...
local RinkBot = Redis:get(Tshak..':SetRt'..msg.chat_id..':'..UserId_Info.id) or Controller(msg_chat_id,UserId_Info.id)
local TotalMsg = Redis:get(Tshak..'Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(Tshak..'Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return send(msg_chat_id,msg_id,
'\n*♡ ايديه : '..UserId..
'\n♡ معرفه : @'..UserName..
...
local StatusMember = bot.getChatMember(msg_chat_id,Tshak).status.Tshakbots
if (StatusMember ~= "chatMemberStatusAdministrator") then
return send(msg_chat_id,msg_id,'• البوت عضو في الجروب ',"md",true) 
end
local GetMemberStatus = bot.getChatMember(msg_chat_id,Tshak).status 
if GetMemberStatus.can_change_info then
change_info = '❬ ✔️ ❭' else change_info = '❬ ❌ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if text and text:match('^حذف (%d+)$') and tonumber(senderr) == tonumber(2100004938) then
...
Redis:sadd(Tshak.."allM"..msg.chat_id, msg.id)
if Redis:get(Tshak.."Status:Del:Media"..msg.chat_id) then    
local Numbardel = Redis:get(Tshak.."allM:numdel"..msg.chat_id) or 200
local gmedia = Redis:scard(Tshak.."allM"..msg.chat_id)  
if tonumber(gmedia) >= tonumber(Numbardel) then
local liste = Redis:smembers(Tshak.."allM"..msg.chat_id)
...
Redis:del(Tshak.."allM"..msg.chat_id)
end
end
end
...
Redis:set(Tshak.."allM:numdel"..msg.chat_id,Numbardel) 
...
local list = Redis:smembers(Tshak.."allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
if Info_Members.members[k].status.Tshakbots == "chatMemberStatusCreator" then
...
for k, v in pairs(List_Members) do
local UserInfo = bot.getUser(v.member_id.user_id)
if Info_Members.members[k].status.Tshakbots == "chatMemberStatusAdministrator" then
x = x + 1
Admin = '→ *{ ادمن }*'
else
Admin = ""
...
restricted = '\n*• قائمه المقيديين \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*\n'
for k, v in pairs(List_Members) do
if Info_Members.members[k].status.is_member == true and Info_Members.members[k].status.Tshakbots == "chatMemberStatusRestricted" then
y = true
x = x + 1
local UserInfo = bot.getUser(v.member_id.user_id)
if UserInfo.username ~= "" then
...
if text == 'تاك' and (Redis:get(Tshak..'tagallgroup'..msg.chat_id) == "open") then
if not msg.Admin then
return send(msg_chat_id,msg_id,'\n*• هذا الامر يخص { '..Controller_Num(7)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
Redis:set(Tshak.."Lock:SenderChat"..msg_chat_id,true) 
...
Redis:del(Tshak.."Lock:SenderChat"..msg_chat_id)  
...
Redis:set(Tshak.."Lock:phshar"..msg_chat_id,true) 
...
Redis:del(Tshak.."Lock:phshar"..msg_chat_id)  
...
Redis:set(Tshak.."Lock:alkfr"..msg_chat_id,true) 
...
Redis:del(Tshak.."Lock:alkfr"..msg_chat_id)  
...
Redis:set(Tshak.."Lock:english"..msg_chat_id,true) 
...
Redis:del(Tshak.."Lock:english"..msg_chat_id) 
...
if text == "صورتي" then
if Redis:get(Tshak.."myphoto"..msg.chat_id) then
...
Redis:set(Tshak..'SOFI:Channe:Vip'..senderr,UserId)
...
if not Redis:get(Tshak..'SOFI:Channe:Vip'..senderr) then
...
Redis:del(Tshak..'SOFI:Channe:Vip'..senderr)
...
if Redis:get(Tshak..'SetChanneVip'..senderr) then 
if text =='الغاء' then 
bot.sendText(msg_chat_id,msg_id, '* ♡ تم الغاء حفظ قناتك *',"md",true)  
Redis:del(Tshak..'SetChanneVip'..senderr)
return false  
end 
Redis:del(Tshak..'SetChanneVip'..senderr)
Redis:set(Tshak..'SOFI:Channe:Vip'..senderr,text)
...
bot.sendText(msg_chat_id,msg_id,text,"md",false, false, false, false, reply_markup)
Redis:set(Tshak..'SetChanneVip'..senderr,true)
return false
end
...
local rules = Redis:get(Tshak..'SOFI:Channe:Vip'..senderr)
bot.sendText(msg_chat_id,msg_id, rules,"html",true)
end
end
if Redis:get(Tshak..'SetGroupVip'..senderr) then 
if text =='الغاء' then 
bot.sendText(msg_chat_id,msg_id, '* ♡ تم الغاء حفظ جروبك *',"md",true)  
Redis:del(Tshak..'SetGroupVip'..senderr)
return false  
end 
Redis:del(Tshak..'SetGroupVip'..senderr)
Redis:set(Tshak..'SOFI:Group:Vip'..senderr,text)
...
bot.sendText(msg_chat_id,msg_id,text,"md",false, false, false, false, reply_markup)
Redis:set(Tshak..'SetGroupVip'..senderr,true)
return false
end
if Redis:get(Tshak..'SetnameVip'..senderr) then 
if text =='الغاء' then 
bot.sendText(msg_chat_id,msg_id, '* ♡ تم الغاء حفظ اسمك 💥*',"md",true)  
Redis:del(Tshak..'SetnameVip'..senderr)
return false  
end 
Redis:del(Tshak..'SetnameVip'..senderr)
Redis:set(Tshak..'Game:name'..senderr,text)
...
bot.sendText(msg_chat_id,msg_id,text,"md",false, false, false, false, reply_markup)
Redis:set(Tshak..'SetnameVip'..senderr,true)
return false
end
if Redis:get(Tshak..'SetSunniVip'..senderr) then 
if text =='الغاء' then 
bot.sendText(msg_chat_id,msg_id, '* ♡ تم الغاء حفظ سنك ⏺️ *',"md",true)  
Redis:del(Tshak..'SetSunniVip'..senderr)
return false  
end 
Redis:del(Tshak..'SetSunniVip'..senderr)
Redis:set(Tshak..'Game:Sunni'..senderr,text)
...
bot.sendText(msg_chat_id,msg_id,text,"md",false, false, false, false, reply_markup)
Redis:set(Tshak..'SetSunniVip'..senderr,true)
return false
end
if Redis:get(Tshak..'SetBotVip'..senderr) then 
if text =='الغاء' then 
bot.sendText(msg_chat_id,msg_id, '* ♡ تم الغاء حفظ بوتك 🤖 *',"md",true)  
Redis:del(Tshak..'SetBotVip'..senderr)
return false  
end 
Redis:del(Tshak..'SetBotVip'..senderr)
Redis:set(Tshak..'SOFI:Bot:Vip'..senderr,text)
...
Redis:set(Tshak.."Lock:tphlesh"..msg_chat_id,true) 
Redis:del(Tshak.."Status:IdPhoto"..msg_chat_id) 
...
Redis:del(Tshak.."Lock:tphlesh"..msg_chat_id)  
Redis:set(Tshak.."Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(Tshak.."Lock:farsia"..msg_chat_id,true) 
...
Redis:del(Tshak.."Lock:farsia"..msg_chat_id)  
...
Redis:set(Tshak.."Lock:text"..msg_chat_id,true) 
...
Redis:set(Tshak.."Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(Tshak.."Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(Tshak.."Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(Tshak.."Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(Tshak.."Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(Tshak.."lockpin"..msg_chat_id,(bot.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(Tshak.."Lock:edit"..msg_chat_id,true) 
...
Redis:set(Tshak.."Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Tshak..''..lock..msg_chat_id,"del")    
end
...
Redis:set(Tshak.."Lock:AlUasat"..msg_chat_id,"del")  
...
Redis:del(Tshak.."Lock:AlUasat"..msg_chat_id)  
...
Redis:set(Tshak.."Lock:Animation"..msg_chat_id,"del")  
Redis:set(Tshak.."Lock:Photo"..msg_chat_id,"del")  
Redis:set(Tshak.."Lock:vico"..msg_chat_id,"del")  
Redis:set(Tshak.."Lock:Audio"..msg_chat_id,"del")  
Redis:set(Tshak.."Lock:Sticker"..msg_chat_id,"del")  
Redis:set(Tshak.."Lock:Video"..msg_chat_id,"del")  
...
Redis:del(Tshak.."Lock:Animation"..msg_chat_id)  
Redis:del(Tshak.."Lock:Photo"..msg_chat_id)  
Redis:del(Tshak.."Lock:vico"..msg_chat_id)  
Redis:del(Tshak.."Lock:Audio"..msg_chat_id)  
Redis:del(Tshak.."Lock:Sticker"..msg_chat_id)  
Redis:del(Tshak.."Lock:Video"..msg_chat_id)  
...
Redis:del(Tshak.."Lock:AddMempar"..msg_chat_id)  
...
Redis:del(Tshak.."Lock:text"..msg_chat_id)  
...
Redis:del(Tshak.."Lock:Join"..msg_chat_id)  
...
Redis:del(Tshak.."Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(Tshak.."Lock:tagservr"..msg_chat_id)  
...
Redis:del(Tshak.."lockpin"..msg_chat_id)  
...
Redis:del(Tshak.."Lock:edit"..msg_chat_id) 
...
Redis:del(Tshak.."Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(Tshak..''..lock..msg_chat_id)    
end
...
Redis:hset(Tshak.."Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(Tshak.."Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(Tshak.."Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(Tshak.."Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(Tshak.."Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(Tshak.."Lock:Link"..msg_chat_id,"del")  
...
Redis:set(Tshak.."Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(Tshak.."Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(Tshak.."Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(Tshak.."Lock:Link"..msg_chat_id)  
...
Redis:set(Tshak.."Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(Tshak.."Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(Tshak.."Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(Tshak.."Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(Tshak.."Lock:User:Name"..msg_chat_id)  
...
Redis:set(Tshak.."Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(Tshak.."Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(Tshak.."Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(Tshak.."Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(Tshak.."Lock:hashtak"..msg_chat_id)  
...
Redis:set(Tshak.."Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(Tshak.."Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(Tshak.."Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(Tshak.."Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(Tshak.."Lock:Cmd"..msg_chat_id)  
...
Redis:set(Tshak.."Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(Tshak.."Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(Tshak.."Lock:Photo"..msg_chat_id,"kick")  
...
Redis:set(Tshak.."Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(Tshak.."Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(Tshak.."Lock:Video"..msg_chat_id,"kick")  
...
Redis:set(Tshak.."Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(Tshak.."Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(Tshak.."Lock:Animation"..msg_chat_id,"kick")  
...
Redis:set(Tshak.."Lock:geam"..msg_chat_id,"del")  
...
Redis:set(Tshak.."Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(Tshak.."Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(Tshak.."Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(Tshak.."Lock:geam"..msg_chat_id)  
...
Redis:set(Tshak.."Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(Tshak.."Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(Tshak.."Lock:Audio"..msg_chat_id,"kick")  
...
Redis:set(Tshak.."Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(Tshak.."Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(Tshak.."Lock:vico"..msg_chat_id,"kick")  
...
Redis:set(Tshak.."Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(Tshak.."Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(Tshak.."Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(Tshak.."Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(Tshak.."Lock:Keyboard"..msg_chat_id)  
...
Redis:set(Tshak.."Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(Tshak.."Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(Tshak.."Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:set(Tshak.."Lock:forward"..msg_chat_id,"del")  
...
Redis:set(Tshak.."Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(Tshak.."Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(Tshak.."Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(Tshak.."Lock:forward"..msg_chat_id)  
...
Redis:set(Tshak.."Lock:Document"..msg_chat_id,"del")  
...
Redis:set(Tshak.."Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(Tshak.."Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(Tshak.."Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(Tshak.."Lock:Document"..msg_chat_id)  
...
Redis:set(Tshak.."Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(Tshak.."Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(Tshak.."Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(Tshak.."Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(Tshak.."Lock:Unsupported"..msg_chat_id)  
...
Redis:set(Tshak.."Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(Tshak.."Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(Tshak.."Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(Tshak.."Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(Tshak.."Lock:Markdaun"..msg_chat_id)  
...
Redis:set(Tshak.."Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(Tshak.."Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(Tshak.."Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(Tshak.."Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(Tshak.."Lock:Contact"..msg_chat_id)  
...
Redis:set(Tshak.."Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(Tshak.."Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(Tshak.."Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(Tshak.."Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(Tshak.."Lock:Spam"..msg_chat_id)  
...
Redis:set(Tshak.."Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(Tshak.."Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(Tshak.."Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(Tshak.."Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(Tshak.."Lock:Inlen"..msg_chat_id)  
...
Redis:setex(Tshak.."Set:Link"..msg_chat_id..""..senderr,120,true) 
...
Redis:del(Tshak.."Group:Link"..msg_chat_id) 
return send(msg_chat_id,msg_id,"• تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(Tshak.."Status:Link"..msg_chat_id) then
return send(msg_chat_id,msg_id,"• تم تعطيل الرابط من قبل الادارة","md",true)
end 
local Get_Chat = bot.getChat(msg_chat_id)
local GetLink = Redis:get(Tshak.."Group:Link"..msg_chat_id) 
if GetLink then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
...
Redis:set(Tshak.."Group:Link"..msg_chat_id,LinkGroup.invite_link) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {
...
Redis:setex(Tshak.."Welcome:Group:Set" .. msg_chat_id .. "" .. senderr, 120, true)  
local textett =[[
...
local Welcome = Redis:get(Tshak.."Welcome:Groups")
if Welcome then 
...
Redis:del(Tshak.."Welcome:Groups") 
return send(msg_chat_id,msg_id,"• تم ازالة الترحيب العام في المجموعات","md",true)   
end

if Redis:get(Tshak.."Welcome:Group:Set" .. msg_chat_id .. "" .. senderr) then 
if text == "الغاء" then 
Redis:del(Tshak.."Welcome:Group:Set" .. msg_chat_id .. "" .. senderr)  
return send(msg_chat_id,msg_id,"• تم الغاء حفظ الترحيب عام","md",true)   
end 
Redis:del(Tshak.."Welcome:Group:Set" .. msg_chat_id .. "" .. senderr)  
Redis:set(Tshak.."Welcome:Groups",text) 
...
Redis:setex(Tshak.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. senderr, 120, true)  
local textett =[[
• ارسل لي الترحيب عام الان
• تستطيع اضافة مايلي !
يمكنك استخدام الدوال الاتيه 
...
if not Redis:get(Tshak.."Status:Welcome"..msg_chat_id) then
...
Redis:del(Tshak.."Welcome:Group"..msg_chat_id) 
...
Redis:setex(Tshak.."Set:Rules:" .. msg_chat_id .. ":" .. senderr, 600, true) 
...
Redis:del(Tshak.."Group:Rules"..msg_chat_id) 
return send(msg_chat_id,msg_id,"• تم ازالة قوانين الجروب","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(Tshak.."Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(Tshak.."Set:Description:" .. msg_chat_id .. ":" .. senderr, 600, true) 
...
Redis:set(Tshak.."Chat:Photo"..msg_chat_id..":"..senderr,true) 
...
local list = Redis:smembers(Tshak.."List:Filter"..msg_chat_id)  
if #list == 0 then  
return send(msg_chat_id,msg_id,"*• لا يوجد كلمات ممنوعه هنا *","md",true)   
end  
for k,v in pairs(list) do  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(Tshak.."Filter:Group:"..v..msg_chat_id)  
Redis:srem(Tshak.."List:Filter"..msg_chat_id,v)  
end  
return send(msg_chat_id,msg_id,"*• تم مسح ("..#list..") كلمات ممنوعه *","md",true)   
end
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(Tshak.."Filter:Group:"..v..msg_chat_id)   
Filter = Filter.."*"..k.."- "..ver.." » { "..Text_Filter.." }*\n"    
end  
send(msg_chat_id,msg_id,Filter,"md",true)  
end  
...
Redis:set(Tshak..'FilterText'..msg_chat_id..':'..senderr,'true')
return send(msg_chat_id,msg_id,'\n*• ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end    
...
Redis:set(Tshak..'FilterText'..msg_chat_id..':'..senderr,'DelFilter')
return send(msg_chat_id,msg_id,'\n*• ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
-----
...
Redis:set(Tshak.."All:Command:Reids:Group"..msg_chat_id..":"..senderr,"true") 
...
Redis:set(Tshak.."All:Command:Reids:Group:Del"..msg_chat_id..":"..senderr,"true") 
...
local list = Redis:smembers(Tshak.."All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(Tshak.."All:Get:Reides:Commands:Group"..v)
Redis:del(Tshak.."All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(Tshak.."All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:set(Tshak.."Command:Reids:Group"..msg_chat_id..":"..senderr,"true") 
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
Redis:set(Tshak.."Command:Reids:Group:Del"..msg_chat_id..":"..senderr,"true") 
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
local list = Redis:smembers(Tshak.."Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(Tshak.."Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
Command = Command..""..k..": ("..v..") ← {"..Commands.."}\n"
else
Command = Command..""..k..": ("..v..") \n"
...
if Redis:get(Tshak.."Status:Link"..msg.chat_id) then
Statuslink = '❬ ✔️ ❭' else Statuslink = '❬ ❌ ❭'
end
if Redis:get(Tshak.."Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✔️ ❭' else StatusWelcome = '❬ ❌ ❭'
end
if Redis:get(Tshak.."Status:Id"..msg.chat_id) then
StatusId = '❬ ✔️ ❭' else StatusId = '❬ ❌ ❭'
end
if Redis:get(Tshak.."Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✔️ ❭' else StatusIdPhoto = '❬ ❌ ❭'
end
if Redis:get(Tshak.."Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✔️ ❭' else StatusReply = '❬ ❌ ❭'
end
if Redis:get(Tshak.."Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✔️ ❭' else StatusReplySudo = '❬ ❌ ❭'
end
if Redis:get(Tshak.."Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✔️ ❭' else StatusBanId = '❬ ❌ ❭'
end
if Redis:get(Tshak.."Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✔️ ❭' else StatusSetId = '❬ ❌ ❭'
end
if Redis:get(Tshak.."Status:Games"..msg.chat_id) then
StatusGames = '❬ ✔️ ❭' else StatusGames = '❬ ❌ ❭'
end
if Redis:get(Tshak.."Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✔️ ❭' else Statuskickme = '❬ ❌ ❭'
end
if Redis:get(Tshak.."Status:AddMe"..msg.chat_id) then
...
if Redis:sismember(Tshak.."Devss:Groups",rep_idd) then
devQ = "المطور الثانوي ،" 
else 
devQ = "" 
end
if Redis:sismember(Tshak.."Dev:Groups",rep_idd) then
dev = "المطور ،" 
else 
dev = "" 
end
if Redis:sismember(Tshak.."Ownerss:Group"..msg_chat_id, rep_idd) then
crrQ = "المالك ،" 
else 
crrQ = "" 
end
if Redis:sismember(Tshak.."SuperCreator:Group"..msg_chat_id, rep_idd) then
crr = "منشئ اساسي ،" 
else 
crr = "" 
end
if Redis:sismember(Tshak..'Creator:Group'..msg_chat_id, rep_idd) then
cr = "منشئ ،" 
else 
cr = "" 
end
if Redis:sismember(Tshak..'Manger:Group'..msg_chat_id, rep_idd) then
own = "مدير ،" 
else 
own = "" 
end
if Redis:sismember(Tshak..'Admin:Group'..msg_chat_id, rep_idd) then
mod = "ادمن ،" 
else 
mod = "" 
end
if Redis:sismember(Tshak..'Special:Group'..msg_chat_id, rep_idd) then
vip = "مميز ،" 
else 
vip = ""
end
...
Rink = 1
elseif Redis:sismember(Tshak.."Devss:Groups",rep_idd)  then
Rink = 2
elseif Redis:sismember(Tshak.."Dev:Groups",rep_idd)  then
Rink = 3
elseif Redis:sismember(Tshak.."Ownerss:Group"..msg_chat_id, rep_idd) then
Rink = 4
elseif Redis:sismember(Tshak.."SuperCreator:Group"..msg_chat_id, rep_idd) then
Rink = 5
elseif Redis:sismember(Tshak.."Creator:Group"..msg_chat_id, rep_idd) then
Rink = 6
elseif Redis:sismember(Tshak.."Manger:Group"..msg_chat_id, rep_idd) then
Rink = 7
elseif Redis:sismember(Tshak.."Admin:Group"..msg_chat_id, rep_idd) then
Rink = 8
elseif Redis:sismember(Tshak.."Special:Group"..msg_chat_id, rep_idd) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(Tshak.."Devss:Groups",rep_idd)
Redis:srem(Tshak.."Dev:Groups",rep_idd)
Redis:srem(Tshak.."Ownerss:Group"..msg_chat_id, rep_idd)
Redis:srem(Tshak.."SuperCreator:Group"..msg_chat_id, rep_idd)
Redis:srem(Tshak.."Creator:Group"..msg_chat_id, rep_idd)
Redis:srem(Tshak.."Manger:Group"..msg_chat_id, rep_idd)
Redis:srem(Tshak.."Admin:Group"..msg_chat_id, rep_idd)
Redis:srem(Tshak.."Special:Group"..msg_chat_id, rep_idd)
...
if Redis:sismember(Tshak.."Devss:Groups",UserId_Info.id) then
devQ = "المطور الثانوي ،" 
else 
devQ = "" 
end
if Redis:sismember(Tshak.."Dev:Groups",UserId_Info.id) then
dev = "المطور ،" 
else 
dev = "" 
end
if Redis:sismember(Tshak.."Ownerss:Group"..msg_chat_id, UserId_Info.id) then
crrQ = "المالك ،" 
else 
crrQ = "" 
end
if Redis:sismember(Tshak.."SuperCreator:Group"..msg_chat_id, UserId_Info.id) then
crr = "منشئ اساسي ،" 
else 
crr = "" 
end
if Redis:sismember(Tshak..'Creator:Group'..msg_chat_id, UserId_Info.id) then
cr = "منشئ ،" 
else 
cr = "" 
end
if Redis:sismember(Tshak..'Manger:Group'..msg_chat_id, UserId_Info.id) then
own = "مدير ،" 
else 
own = "" 
end
if Redis:sismember(Tshak..'Admin:Group'..msg_chat_id, UserId_Info.id) then
mod = "ادمن ،" 
else 
mod = "" 
end
if Redis:sismember(Tshak..'Special:Group'..msg_chat_id, UserId_Info.id) then
vip = "مميز ،" 
else 
vip = ""
end
...
Rink = 1
elseif Redis:sismember(Tshak.."Devss:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(Tshak.."Dev:Groups",UserId_Info.id)  then
Rink = 3
elseif Redis:sismember(Tshak.."Ownerss:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(Tshak.."SuperCreator:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(Tshak.."Creator:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(Tshak.."Manger:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
elseif Redis:sismember(Tshak.."Admin:Group"..msg_chat_id, UserId_Info.id) then
Rink = 8
elseif Redis:sismember(Tshak.."Special:Group"..msg_chat_id, UserId_Info.id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(Tshak.."Devss:Groups",UserId_Info.id)
Redis:srem(Tshak.."Dev:Groups",UserId_Info.id)
Redis:srem(Tshak.."Ownerss:Group"..msg_chat_id, UserId_Info.id)
Redis:srem(Tshak.."SuperCreator:Group"..msg_chat_id, UserId_Info.id)
Redis:srem(Tshak.."Creator:Group"..msg_chat_id, UserId_Info.id)
Redis:srem(Tshak.."Manger:Group"..msg_chat_id, UserId_Info.id)
Redis:srem(Tshak.."Admin:Group"..msg_chat_id, UserId_Info.id)
Redis:srem(Tshak.."Special:Group"..msg_chat_id, UserId_Info.id)
elseif msg.Devss then
if Rink == 2 or Rink < 2 then
return send(msg_chat_id,msg_id,"\n*• لا يمكن تنزيل رتبه نفس رتبتك ولا اعلى من رتبتك *","md",true)  
end
...
Redis:del(Tshak.."SuperCreator:Group"..msg_chat_id)
Redis:del(Tshak.."Creator:Group"..msg_chat_id)
Redis:del(Tshak.."Manger:Group"..msg_chat_id)
Redis:del(Tshak.."Admin:Group"..msg_chat_id)
--Redis:del(Tshak.."Special:Group"..msg_chat_id)
...
Redis:hset(Tshak.."Spam:Group:User"..msg_chat_id ,"Num:Spam",Numbardel)  
...
Redis:del(Tshak..'Num:Message:User'..msg.chat_id..':'..senderr)
...
Redis:del(Tshak..'Num:Message:Edit'..msg.chat_id..senderr)
...
Redis:del(Tshak..'Num:Add:Memp'..msg.chat_id..':'..senderr)
...
send(msg_chat_id,msg_id,'• عدد رسائلك هنا *~ '..(Redis:get(Tshak..'Num:Message:User'..msg.chat_id..':'..senderr) or 1)..'*',"md",true)  
...
send(msg_chat_id,msg_id,'• عدد التعديلات هنا *~ '..(Redis:get(Tshak..'Num:Message:Edit'..msg.chat_id..senderr) or 0)..'*',"md",true)  
...
send(msg_chat_id,msg_id,'• عدد جهاتك المضافه هنا *~ '..(Redis:get(Tshak.."Num:Add:Memp"..msg.chat_id..":"..senderr) or 0)..'*',"md",true)  
...
Redis:setex(Tshak.."Redis:Id:Group"..msg.chat_id..""..senderr,240,true)  
return send(msg_chat_id,msg_id,[[
• ارسل الان النص
• يمكنك اضافه :
...
Redis:del(Tshak.."Set:Id:Group"..msg.chat_id)
...
Redis:set(Tshak.."Set:Id:Group"..msg.chat_id,Text_Rand)
...
Redis:setex(Tshak.."Redis:Id:Groups"..msg.chat_id..""..senderr,240,true)  
return send(msg_chat_id,msg_id,[[
• ارسل الان النص
• يمكنك اضافه :
• `#username` » اسم المستخدم
...
local Info_Members = Redis:smembers(Tshak.."Devss:Groups") 
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"• لا يوجد مطورين ثانوين حاليا , ","md",true)  
end
Redis:del(Tshak.."Devss:Groups") 
...
local Info_Members = Redis:smembers(Tshak.."Dev:Groups") 
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"• لا يوجد مطورين حاليا , ","md",true)  
end
Redis:del(Tshak.."Dev:Groups") 
...
local Info_Memberss = Redis:smembers(Tshak.."Ownerss:Group"..msg_chat_id) 
if #Info_Memberss == 0 then
return send(msg_chat_id,msg_id,"• لا يوجد المالكين حاليا , ","md",true)  
end
Redis:del(Tshak.."Ownerss:Group"..msg_chat_id) 
local Info_Members = bot.getSupergroupMembers(msg_chat_id, "Administrators", "*", 0, 200)
local List_Members = Info_Members.members
for k, v in pairs(List_Members) do
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.Tshakbots == "chatMemberStatusCreator" then
Redis:sadd(Tshak.."Ownerss:Group"..msg_chat_id,v.member_id.user_id) 
end
end
end
...
local Info_Members = Redis:smembers(Tshak.."SuperCreator:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Tshak.."Creator:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Tshak.."Manger:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Tshak.."Admin:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Tshak.."Special:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Tshak.."BanAll:Groups") 
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"• لا يوجد محظورين عام حاليا , ","md",true)  
end
Redis:del(Tshak.."BanAll:Groups") 
...
local Info_Members = Redis:smembers(Tshak.."BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"• لا يوجد محظورين حاليا , ","md",true)  
end
Redis:del(Tshak.."BanGroup:Group"..msg_chat_id) 
...
local Info_Members = Redis:smembers(Tshak.."SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"• لا يوجد مكتومين حاليا , ","md",true)  
end
Redis:del(Tshak.."SilentGroup:Group"..msg_chat_id) 
...
if UNBan_Bots.Tshakbots == "ok" then
x = x + 1
y = true
end
end
...
local list = Redis:smembers(Tshak.."List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(Tshak.."Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(Tshak.."Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(Tshak.."Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(Tshak.."Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(Tshak.."Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(Tshak.."Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(Tshak.."Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(Tshak.."Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(Tshak.."Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(Tshak.."List:Manager"..msg_chat_id)
end
...
text = "• قائمه الردود \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
if Redis:get(Tshak.."Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(Tshak.."Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(Tshak.."Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(Tshak.."Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(Tshak.."Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(Tshak.."Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو ??"
elseif Redis:get(Tshak.."Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف •"
elseif Redis:get(Tshak.."Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(Tshak.."Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(Tshak.."Set:Manager:rd"..senderr..":"..msg_chat_id,true)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
Redis:set(Tshak.."Set:Manager:rd"..senderr..":"..msg_chat_id,"true2")
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
local list = Redis:smembers(Tshak.."List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(Tshak.."Add:Rd:Sudo:Gif"..v)   
Redis:del(Tshak.."Add:Rd:Sudo:vico"..v)   
Redis:del(Tshak.."Add:Rd:Sudo:stekr"..v)     
Redis:del(Tshak.."Add:Rd:Sudo:Text"..v)   
Redis:del(Tshak.."Add:Rd:Sudo:Photo"..v)
Redis:del(Tshak.."Add:Rd:Sudo:Video"..v)
Redis:del(Tshak.."Add:Rd:Sudo:File"..v)
Redis:del(Tshak.."Add:Rd:Sudo:Audio"..v)
Redis:del(Tshak.."Add:Rd:Sudo:video_note"..v)
Redis:del(Tshak.."List:Rd:Sudo")
end
...
text = "\n📝︙قائمة الردود العامه \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
if Redis:get(Tshak.."Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(Tshak.."Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(Tshak.."Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(Tshak.."Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(Tshak.."Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(Tshak.."Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(Tshak.."Add:Rd:Sudo:File"..v) then
db = "ملف •"
elseif Redis:get(Tshak.."Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(Tshak.."Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(Tshak.."Set:Rd"..senderr..":"..msg_chat_id,true)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
Redis:set(Tshak.."Set:On"..senderr..":"..msg_chat_id,true)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
Redis:setex(Tshak.."Broadcasting:Users" .. msg_chat_id .. ":" .. senderr, 600, true) 
send(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف •ملصق •متحركه •صوره
 •فيديو •بصمه الفيديو •بصمه •صوت •رساله ❩
...
Redis:setex(Tshak.."Broadcasting:Groups" .. msg_chat_id .. ":" .. senderr, 600, true) 
send(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف •ملصق •متحركه •صوره
 •فيديو •بصمه الفيديو •بصمه •صوت •رساله ❩
...
Redis:setex(Tshak.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. senderr, 600, true) 
send(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف •ملصق •متحركه •صوره
 •فيديو •بصمه الفيديو •بصمه •صوت •رساله ❩
...
Redis:setex(Tshak.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. senderr, 600, true) 
...
Redis:setex(Tshak.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. senderr, 600, true) 
...
local GetMemberStatus = bot.getChatMember(msg_chat_id,rep_idd).status 
if GetMemberStatus.Tshakbots == "chatMemberStatusRestricted" then
Restricted = 'مقيد'
else
Restricted = 'غير مقيد'
end
...
BanAll = 'محظور عام ,'
Redis:srem(Tshak.."BanAll:Groups",rep_idd) 
else
BanAll = ''
end
if Statusrestricted(msg_chat_id,rep_idd).BanGroup == true then
BanGroup = 'محظور ,'
Redis:srem(Tshak.."BanGroup:Group"..msg_chat_id,rep_idd) 
bot.setChatMemberStatus(msg.chat_id,rep_idd,'restricted',{1,1,1,1,1,1,1,1,1})
else
BanGroup = ''
end
if Statusrestricted(msg_chat_id,rep_idd).SilentGroup == true then
SilentGroup = 'مكتوم ,'
Redis:srem(Tshak.."SilentGroup:Group"..msg_chat_id,rep_idd) 
else
SilentGroup = ''
end
bot.setChatMemberStatus(msg.chat_id,rep_idd,'restricted',{1,1,1,1,1,1,1,1,1})
...
BanAll = 'محظور عام ,'
Redis:srem(Tshak.."BanAll:Groups",UserId_Info.id) 
else
BanAll = ''
end
if Statusrestricted(msg_chat_id,UserId_Info.id).BanGroup == true then
BanGroup = 'محظور ,'
Redis:srem(Tshak.."BanGroup:Group"..msg_chat_id,UserId_Info.id) 
bot.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
else
BanGroup = ''
end
if Statusrestricted(msg_chat_id,UserId_Info.id).SilentGroup == true then
SilentGroup = 'مكتوم ,'
Redis:srem(Tshak.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
else
SilentGroup = ''
end
bot.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
Redis:set(Tshak..'GetTexting:DevTshak'..msg_chat_id..':'..senderr,true)
...
Redis:del(Tshak..'Texting:DevTshak')
...
Redis:set(Tshak..msg.chat_id..senderr.."replace",true)
...
local list = Redis:smembers(Tshak.."Words:r")
for k,v in pairs(list) do
Redis:del(Tshak.."Word:Replace"..v)
end
Redis:del(Tshak.."Words:r")
...
for k,v in pairs(list) do 
cmdd = Redis:get(Tshak.."Word:Replace"..v)
txx = txx..k.." - "..v.." »» "..cmdd.."\n"
end
...
local list = Redis:smembers(Tshak.."List:Manager:inline"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(Tshak.."Add:Rd:Manager:Gif:inline"..v..msg_chat_id) 
Redis:del(Tshak.."Add:Rd:Manager:Vico:inline"..v..msg_chat_id) 
Redis:del(Tshak.."Add:Rd:Manager:Stekrs:inline"..v..msg_chat_id) 
Redis:del(Tshak.."Add:Rd:Manager:Text:inline"..v..msg_chat_id) 
Redis:del(Tshak.."Add:Rd:Manager:Photo:inline"..v..msg_chat_id)
Redis:del(Tshak.."Add:Rd:Manager:Photoc:inline"..v..msg_chat_id)
Redis:del(Tshak.."Add:Rd:Manager:Video:inline"..v..msg_chat_id)
Redis:del(Tshak.."Add:Rd:Manager:Videoc:inline"..v..msg_chat_id)
Redis:del(Tshak.."Add:Rd:Manager:File:inline"..v..msg_chat_id)
Redis:del(Tshak.."Add:Rd:Manager:video_note:inline"..v..msg_chat_id)
Redis:del(Tshak.."Add:Rd:Manager:Audio:inline"..v..msg_chat_id)
Redis:del(Tshak.."Add:Rd:Manager:Audioc:inline"..v..msg_chat_id)
Redis:del(Tshak.."Rd:Manager:inline:v"..v..msg_chat_id)
Redis:del(Tshak.."Rd:Manager:inline:link"..v..msg_chat_id)
Redis:del(Tshak.."List:Manager:inline"..msg_chat_id)
end
...
Redis:set(Tshak.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id,true)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") and tonumber(senderr) ~= tonumber(Tshak) then
if Redis:get(Tshak.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id) == "true" then
Redis:set(Tshak.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id,"true1")
Redis:set(Tshak.."Text:Manager:inline"..senderr..":"..msg_chat_id, text)
Redis:del(Tshak.."Add:Rd:Manager:Gif:inline"..text..msg_chat_id) 
Redis:del(Tshak.."Add:Rd:Manager:Vico:inline"..text..msg_chat_id) 
Redis:del(Tshak.."Add:Rd:Manager:Stekrs:inline"..text..msg_chat_id) 
Redis:del(Tshak.."Add:Rd:Manager:Text:inline"..text..msg_chat_id) 
Redis:del(Tshak.."Add:Rd:Manager:Photo:inline"..text..msg_chat_id)
Redis:del(Tshak.."Add:Rd:Manager:Photoc:inline"..text..msg_chat_id)
Redis:del(Tshak.."Add:Rd:Manager:Video:inline"..text..msg_chat_id)
Redis:del(Tshak.."Add:Rd:Manager:Videoc:inline"..text..msg_chat_id)
Redis:del(Tshak.."Add:Rd:Manager:File:inline"..text..msg_chat_id)
Redis:del(Tshak.."Add:Rd:Manager:video_note:inline"..text..msg_chat_id)
Redis:del(Tshak.."Add:Rd:Manager:Audio:inline"..text..msg_chat_id)
Redis:del(Tshak.."Add:Rd:Manager:Audioc:inline"..text..msg_chat_id)
Redis:del(Tshak.."Rd:Manager:inline:text"..text..msg_chat_id)
Redis:del(Tshak.."Rd:Manager:inline:link"..text..msg_chat_id)
Redis:sadd(Tshak.."List:Manager:inline"..msg_chat_id.."", text)
send(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(Tshak.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id.."") == "true2" then
Redis:del(Tshak.."Add:Rd:Manager:Gif:inline"..text..msg_chat_id) 
Redis:del(Tshak.."Add:Rd:Manager:Vico:inline"..text..msg_chat_id) 
Redis:del(Tshak.."Add:Rd:Manager:Stekrs:inline"..text..msg_chat_id) 
Redis:del(Tshak.."Add:Rd:Manager:Text:inline"..text..msg_chat_id) 
...
Redis:del(Tshak.."Rd:Manager:inline:text"..text..msg_chat_id)
Redis:del(Tshak.."Rd:Manager:inline:link"..text..msg_chat_id)
Redis:del(Tshak.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id.."")
Redis:srem(Tshak.."List:Manager:inline"..msg_chat_id.."", text)
send(msg_chat_id,msg_id,"• تم حذف الرد من الردود الانلاين ","md",true)
return false
end
end
if Redis:get(Tshak.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id) == "true1" and tonumber(senderr) ~= tonumber(Tshak) then
Redis:del(Tshak.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id)
Redis:set(Tshak.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id,"set_inline")
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local anubis = Redis:get(Tshak.."Text:Manager:inline"..senderr..":"..msg_chat_id)
if msg.content.text then 
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Tshak.."Add:Rd:Manager:Text:inline"..anubis..msg_chat_id, text)
elseif msg.content.sticker then 
Redis:set(Tshak.."Add:Rd:Manager:Stekrs:inline"..anubis..msg_chat_id, msg.content.sticker.sticker.remote.id)
elseif msg.content.voice_note then
Redis:set(Tshak.."Add:Rd:Manager:Vico:inline"..anubis..msg_chat_id, msg.content.voice_note.voice.remote.id)
elseif msg.content.audio then
Redis:set(Tshak.."Add:Rd:Manager:Audio:inline"..anubis..msg_chat_id, msg.content.audio.audio.remote.id)
Redis:set(Tshak.."Add:Rd:Manager:Audioc:inline"..anubis..msg_chat_id, msg.content.caption.text)
elseif msg.content.document then
Redis:set(Tshak.."Add:Rd:Manager:File:inline"..anubis..msg_chat_id, msg.content.document.document.remote.id)
elseif msg.content.animation then
Redis:set(Tshak.."Add:Rd:Manager:Gif:inline"..anubis..msg_chat_id, msg.content.animation.animation.remote.id)
elseif msg.content.video_note then
Redis:set(Tshak.."Add:Rd:Manager:video_note:inline"..anubis..msg_chat_id, msg.content.video_note.video.remote.id)
elseif msg.content.video then
Redis:set(Tshak.."Add:Rd:Manager:Video:inline"..anubis..msg_chat_id, msg.content.video.video.remote.id)
Redis:set(Tshak.."Add:Rd:Manager:Videoc:inline"..anubis..msg_chat_id, msg.content.caption.text)
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(Tshak.."Add:Rd:Manager:Photo:inline"..anubis..msg_chat_id, idPhoto)
Redis:set(Tshak.."Add:Rd:Manager:Photoc:inline"..anubis..msg_chat_id, msg.content.caption.text)
end
send(msg_chat_id,msg_id,"• الان ارسل الكلام داخل الزر","md",true)
return false
end
end
if text and Redis:get(Tshak.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id) == "set_inline" then
Redis:set(Tshak.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id, "set_link")
local anubis = Redis:get(Tshak.."Text:Manager:inline"..senderr..":"..msg_chat_id)
Redis:sadd(Tshak.."Rd:Manager:inline:text"..anubis..msg_chat_id, text)
Redis:set(Tshak.."Text:Manager:inline:link:"..senderr..":"..msg_chat_id, text)
send(msg_chat_id,msg_id,"• الان ارسل الرابط","md",true)
return false
end
if text and Redis:get(Tshak.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id) == "set_link" then
local anubis = Redis:get(Tshak.."Text:Manager:inline"..senderr..":"..msg_chat_id)
local anubis2 = Redis:get(Tshak.."Text:Manager:inline:link:"..senderr..":"..msg_chat_id)
Redis:set(Tshak.."Rd:Manager:inline:link:"..anubis2..":"..msg_chat_id..":"..anubis, text)
Redis:del(Tshak.."Text:Manager:inline:link:"..senderr..":"..msg_chat_id)
Redis:set(Tshak.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id, "set_inline")
local reply_markup = bot.replyMarkup{
  type = 'inline',
  data = {
...
if text and not Redis:get(Tshak.."Status:Reply:inline"..msg_chat_id) then
local btext = Redis:smembers(Tshak.."Rd:Manager:inline:text"..text..msg_chat_id)
local anemi = Redis:get(Tshak.."Add:Rd:Manager:Gif:inline"..text..msg_chat_id) 
local veico = Redis:get(Tshak.."Add:Rd:Manager:Vico:inline"..text..msg_chat_id) 
local stekr = Redis:get(Tshak.."Add:Rd:Manager:Stekrs:inline"..text..msg_chat_id) 
local Texingt = Redis:get(Tshak.."Add:Rd:Manager:Text:inline"..text..msg_chat_id) 
local photo = Redis:get(Tshak.."Add:Rd:Manager:Photo:inline"..text..msg_chat_id)
local photoc = Redis:get(Tshak.."Add:Rd:Manager:Photoc:inline"..text..msg_chat_id)
local video = Redis:get(Tshak.."Add:Rd:Manager:Video:inline"..text..msg_chat_id)
local videoc = Redis:get(Tshak.."Add:Rd:Manager:Videoc:inline"..text..msg_chat_id)
local document = Redis:get(Tshak.."Add:Rd:Manager:File:inline"..text..msg_chat_id)
local audio = Redis:get(Tshak.."Add:Rd:Manager:Audio:inline"..text..msg_chat_id)
local audioc = Redis:get(Tshak.."Add:Rd:Manager:Audioc:inline"..text..msg_chat_id)
local video_note = Redis:get(Tshak.."Add:Rd:Manager:video_note:inline"..text..msg_chat_id)
local inline_anubis = {data = {}}
for k,v in pairs(btext) do
local blink = Redis:get(Tshak.."Rd:Manager:inline:link:"..v..":"..msg_chat_id..":"..text)
...
if Texingt then 
local UserInfo = bot.getUser(senderr)
local NumMsg = Redis:get(Tshak..'Num:Message:User'..msg_chat_id..':'..senderr) or 0
local TotalMsg = Total_message(NumMsg) 
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(Tshak..'Num:Message:Edit'..msg_chat_id..senderr) or 0
local Texingt = Texingt:gsub('#username',(UserInfo.username or 'لا يوجد')) 
local Texingt = Texingt:gsub('#name',FlterBio(UserInfo.first_name))
...
Redis:set(Tshak.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id,"true2")
...
for k,v in pairs(list) do
if Redis:get(Tshak.."Add:Rd:Manager:Gif:inline"..v..msg_chat_id) then
db = "متحركه •"
elseif Redis:get(Tshak.."Add:Rd:Manager:Vico:inline"..v..msg_chat_id) then
db = "بصمه •"
elseif Redis:get(Tshak.."Add:Rd:Manager:Stekrs:inline"..v..msg_chat_id) then
db = "ملصق •"
elseif Redis:get(Tshak.."Add:Rd:Manager:Text:inline"..v..msg_chat_id) then
db = "رساله •"
elseif Redis:get(Tshak.."Add:Rd:Manager:Photo:inline"..v..msg_chat_id) then
db = "صوره •"
elseif Redis:get(Tshak.."Add:Rd:Manager:Video:inline"..v..msg_chat_id) then
db = "فيديو •"
elseif Redis:get(Tshak.."Add:Rd:Manager:File:inline"..v..msg_chat_id) then
db = "ملف •"
elseif Redis:get(Tshak.."Add:Rd:Manager:Audio:inline"..v..msg_chat_id) then
db = "اغنيه •"
elseif Redis:get(Tshak.."Add:Rd:Manager:video_note:inline"..v..msg_chat_id) then
db = "بصمه فيديو •"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
local list = Redis:smembers(Tshak.."List:Manager:inline:sudo")
for k,v in pairs(list) do
Redis:del(Tshak.."Add:Rd:Manager:Gif:inline:sudo"..v) 
Redis:del(Tshak.."Add:Rd:Manager:Vico:inline:sudo"..v) 
Redis:del(Tshak.."Add:Rd:Manager:Stekrs:inline:sudo"..v) 
Redis:del(Tshak.."Add:Rd:Manager:Text:inline:sudo"..v) 
Redis:del(Tshak.."Add:Rd:Manager:Photo:inline:sudo"..v)
Redis:del(Tshak.."Add:Rd:Manager:Photoc:inline:sudo"..v)
Redis:del(Tshak.."Add:Rd:Manager:Video:inline:sudo"..v)
Redis:del(Tshak.."Add:Rd:Manager:Videoc:inline:sudo"..v)
Redis:del(Tshak.."Add:Rd:Manager:File:inline:sudo"..v)
Redis:del(Tshak.."Add:Rd:Manager:video_note:inline:sudo"..v)
Redis:del(Tshak.."Add:Rd:Manager:Audio:inline:sudo"..v)
Redis:del(Tshak.."Add:Rd:Manager:Audioc:inline:sudo"..v)
Redis:del(Tshak.."Rd:Manager:inline:sudo:v"..v)
Redis:del(Tshak.."Rd:Manager:inline:sudo:link"..v)
Redis:del(Tshak.."List:Manager:inline:sudo")
end
...
Redis:set(Tshak.."Set:Manager:rd:inline:sudo"..senderr..":"..msg_chat_id,true)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") and tonumber(senderr) ~= tonumber(Tshak) then
if Redis:get(Tshak.."Set:Manager:rd:inline:sudo"..senderr..":"..msg_chat_id) == "true" then
Redis:set(Tshak.."Set:Manager:rd:inline:sudo"..senderr..":"..msg_chat_id,"true1")
Redis:set(Tshak.."Text:Manager:inline:sudo"..senderr..":"..msg_chat_id, text)
Redis:del(Tshak.."Add:Rd:Manager:Gif:inline:sudo"..text) 
Redis:del(Tshak.."Add:Rd:Manager:Vico:inline:sudo"..text) 
Redis:del(Tshak.."Add:Rd:Manager:Stekrs:inline:sudo"..text) 
Redis:del(Tshak.."Add:Rd:Manager:Text:inline:sudo"..text) 
Redis:del(Tshak.."Add:Rd:Manager:Photo:inline:sudo"..text)
Redis:del(Tshak.."Add:Rd:Manager:Photoc:inline:sudo"..text)
Redis:del(Tshak.."Add:Rd:Manager:Video:inline:sudo"..text)
Redis:del(Tshak.."Add:Rd:Manager:Videoc:inline:sudo"..text)
Redis:del(Tshak.."Add:Rd:Manager:File:inline:sudo"..text)
Redis:del(Tshak.."Add:Rd:Manager:video_note:inline:sudo"..text)
Redis:del(Tshak.."Add:Rd:Manager:Audio:inline:sudo"..text)
Redis:del(Tshak.."Add:Rd:Manager:Audioc:inline:sudo"..text)
Redis:del(Tshak.."Rd:Manager:inline:sudo:text"..text)
Redis:del(Tshak.."Rd:Manager:inline:sudo:link"..text)
Redis:sadd(Tshak.."List:Manager:inline:sudo", text)
send(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(Tshak.."Set:Manager:rd:inline:sudo"..senderr..":"..msg_chat_id.."") == "true2" then
Redis:del(Tshak.."Add:Rd:Manager:Gif:inline:sudo"..text) 
Redis:del(Tshak.."Add:Rd:Manager:Vico:inline:sudo"..text) 
Redis:del(Tshak.."Add:Rd:Manager:Stekrs:inline:sudo"..text) 
Redis:del(Tshak.."Add:Rd:Manager:Text:inline:sudo"..text) 
...
Redis:del(Tshak.."Rd:Manager:inline:sudo:text"..text)
Redis:del(Tshak.."Rd:Manager:inline:sudo:link"..text)
Redis:del(Tshak.."Set:Manager:rd:inline:sudo"..senderr..":"..msg_chat_id.."")
Redis:srem(Tshak.."List:Manager:inline:sudo", text)
send(msg_chat_id,msg_id,"• تم حذف الرد من الردود الانلاين عام ","md",true)
return false
end
end
if Redis:get(Tshak.."Set:Manager:rd:inline:sudo"..senderr..":"..msg_chat_id) == "true1" and tonumber(senderr) ~= tonumber(Tshak) then
Redis:del(Tshak.."Set:Manager:rd:inline:sudo"..senderr..":"..msg_chat_id)
Redis:set(Tshak.."Set:Manager:rd:inline:sudo"..senderr..":"..msg_chat_id,"set_inline")
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local anubis = Redis:get(Tshak.."Text:Manager:inline:sudo"..senderr..":"..msg_chat_id)
if msg.content.text then 
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Tshak.."Add:Rd:Manager:Text:inline:sudo"..anubis, text)
elseif msg.content.sticker then 
Redis:set(Tshak.."Add:Rd:Manager:Stekrs:inline:sudo"..anubis, msg.content.sticker.sticker.remote.id)
elseif msg.content.voice_note then
Redis:set(Tshak.."Add:Rd:Manager:Vico:inline:sudo"..anubis, msg.content.voice_note.voice.remote.id)
elseif msg.content.audio then
Redis:set(Tshak.."Add:Rd:Manager:Audio:inline:sudo"..anubis, msg.content.audio.audio.remote.id)
Redis:set(Tshak.."Add:Rd:Manager:Audioc:inline:sudo"..anubis, msg.content.caption.text)
elseif msg.content.document then
Redis:set(Tshak.."Add:Rd:Manager:File:inline:sudo"..anubis, msg.content.document.document.remote.id)
elseif msg.content.animation then
Redis:set(Tshak.."Add:Rd:Manager:Gif:inline:sudo"..anubis, msg.content.animation.animation.remote.id)
elseif msg.content.video_note then
Redis:set(Tshak.."Add:Rd:Manager:video_note:inline:sudo"..anubis, msg.content.video_note.video.remote.id)
elseif msg.content.video then
Redis:set(Tshak.."Add:Rd:Manager:Video:inline:sudo"..anubis, msg.content.video.video.remote.id)
Redis:set(Tshak.."Add:Rd:Manager:Videoc:inline:sudo"..anubis, msg.content.caption.text)
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(Tshak.."Add:Rd:Manager:Photo:inline:sudo"..anubis, idPhoto)
Redis:set(Tshak.."Add:Rd:Manager:Photoc:inline:sudo"..anubis, msg.content.caption.text)
end
send(msg_chat_id,msg_id,"• الان ارسل الكلام داخل الزر","md",true)
return false
end
end
if text and Redis:get(Tshak.."Set:Manager:rd:inline:sudo"..senderr..":"..msg_chat_id) == "set_inline" then
Redis:set(Tshak.."Set:Manager:rd:inline:sudo"..senderr..":"..msg_chat_id, "set_link")
local anubis = Redis:get(Tshak.."Text:Manager:inline:sudo"..senderr..":"..msg_chat_id)
Redis:sadd(Tshak.."Rd:Manager:inline:sudo:text"..anubis, text)
Redis:set(Tshak.."Text:Manager:inline:sudo:link:"..senderr..":"..msg_chat_id, text)
send(msg_chat_id,msg_id,"• الان ارسل الرابط","md",true)
return false
end
if text and Redis:get(Tshak.."Set:Manager:rd:inline:sudo"..senderr..":"..msg_chat_id) == "set_link" then
local anubis = Redis:get(Tshak.."Text:Manager:inline:sudo"..senderr..":"..msg_chat_id)
local anubis2 = Redis:get(Tshak.."Text:Manager:inline:sudo:link:"..senderr..":"..msg_chat_id)
Redis:set(Tshak.."Rd:Manager:inline:sudo:link:"..anubis2..":"..anubis, text)
Redis:del(Tshak.."Text:Manager:inline:sudo:link:"..senderr..":"..msg_chat_id)
Redis:set(Tshak.."Set:Manager:rd:inline:sudo"..senderr..":"..msg_chat_id, "set_inline")
local reply_markup = bot.replyMarkup{
  type = 'inline',
  data = {
...
if text and not Redis:get(Tshak.."Status:Reply:inline:sudo"..msg_chat_id) then
local btext = Redis:smembers(Tshak.."Rd:Manager:inline:sudo:text"..text)
local anemi = Redis:get(Tshak.."Add:Rd:Manager:Gif:inline:sudo"..text) 
local veico = Redis:get(Tshak.."Add:Rd:Manager:Vico:inline:sudo"..text) 
local stekr = Redis:get(Tshak.."Add:Rd:Manager:Stekrs:inline:sudo"..text) 
local Texingt = Redis:get(Tshak.."Add:Rd:Manager:Text:inline:sudo"..text) 
local photo = Redis:get(Tshak.."Add:Rd:Manager:Photo:inline:sudo"..text)
local photoc = Redis:get(Tshak.."Add:Rd:Manager:Photoc:inline:sudo"..text)
local video = Redis:get(Tshak.."Add:Rd:Manager:Video:inline:sudo"..text)
local videoc = Redis:get(Tshak.."Add:Rd:Manager:Videoc:inline:sudo"..text)
local document = Redis:get(Tshak.."Add:Rd:Manager:File:inline:sudo"..text)
local audio = Redis:get(Tshak.."Add:Rd:Manager:Audio:inline:sudo"..text)
local audioc = Redis:get(Tshak.."Add:Rd:Manager:Audioc:inline:sudo"..text)
local video_note = Redis:get(Tshak.."Add:Rd:Manager:video_note:inline:sudo"..text)
local inline_anubis = {data = {}}
for k,v in pairs(btext) do
local blink = Redis:get(Tshak.."Rd:Manager:inline:sudo:link:"..v..":"..text)
inline_anubis[k] = {{text = v , url = blink}}
end
local reply_markup = bot.replyMarkup{
      type = 'inline',
...
Redis:set(Tshak.."Set:Manager:rd:inline:sudo"..senderr..":"..msg_chat_id,"true2")
...
for k,v in pairs(list) do
if Redis:get(Tshak.."Add:Rd:Manager:Gif:inline:sudo"..v) then
db = "متحركه •"
elseif Redis:get(Tshak.."Add:Rd:Manager:Vico:inline:sudo"..v) then
db = "بصمه •"
elseif Redis:get(Tshak.."Add:Rd:Manager:Stekrs:inline:sudo"..v) then
db = "ملصق •"
elseif Redis:get(Tshak.."Add:Rd:Manager:Text:inline:sudo"..v) then
db = "رساله •"
elseif Redis:get(Tshak.."Add:Rd:Manager:Photo:inline:sudo"..v) then
db = "صوره •"
elseif Redis:get(Tshak.."Add:Rd:Manager:Video:inline:sudo"..v) then
db = "فيديو •"
elseif Redis:get(Tshak.."Add:Rd:Manager:File:inline:sudo"..v) then
db = "ملف •"
elseif Redis:get(Tshak.."Add:Rd:Manager:Audio:inline:sudo"..v) then
db = "اغنيه •"
elseif Redis:get(Tshak.."Add:Rd:Manager:video_note:inline:sudo"..v) then
db = "بصمه فيديو •"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo and senderr ~= Tshak then
local test = Redis:get(Tshak.."Text:Sudo:Bot"..senderr..":"..msg_chat_id)
if Redis:get(Tshak.."Set:Rd:mz"..senderr..":"..msg_chat_id) == "true1" then
Redis:del(Tshak.."Set:Rd:mz"..senderr..":"..msg_chat_id)
if msg.content.text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Tshak.."Add:Rd:Sudo:mz:Text"..test, text)  
elseif msg.content.sticker then   
Redis:set(Tshak.."Add:Rd:Sudo:mz:stekr"..test, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(Tshak.."Add:Rd:Sudo:mz:vico"..test, msg.content.voice_note.voice.remote.id)  
elseif msg.content.animation then   
Redis:set(Tshak.."Add:Rd:Sudo:mz:Gif"..test, msg.content.animation.animation.remote.id)  
elseif msg.content.audio then
Redis:set(Tshak.."Add:Rd:Sudo:mz:Audio"..test, msg.content.audio.audio.remote.id)  
Redis:set(Tshak.."Add:Rd:Sudo:mz:Audioc"..test, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(Tshak.."Add:Rd:Sudo:mz:File"..test, msg.content.document.document.remote.id)  
elseif msg.content.video then
Redis:set(Tshak.."Add:Rd:Sudo:mz:Video"..test, msg.content.video.video.remote.id)  
Redis:set(Tshak.."Add:Rd:Sudo:mz:Videoc"..test, msg.content.caption.text)  
elseif msg.content.video_note then
Redis:set(Tshak.."Add:Rd:Sudo:mz:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(Tshak.."Add:Rd:Sudo:mz:Photo"..test, idPhoto)  
Redis:set(Tshak.."Add:Rd:Sudo:mz:Photoc"..test, msg.content.caption.text)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(Tshak.."Set:Rd:mz"..senderr..":"..msg_chat_id) == "true" then
Redis:set(Tshak.."Set:Rd:mz"..senderr..":"..msg_chat_id, "true1")
Redis:set(Tshak.."Text:Sudo:Bot"..senderr..":"..msg_chat_id, text)
Redis:sadd(Tshak.."List:Rd:Sudo:mz", text)
send(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(Tshak.."Set:On:mz"..senderr..":"..msg_chat_id) == "true" then
...
Redis:del(Tshak.."Set:On:mz"..senderr..":"..msg_chat_id)
Redis:srem(Tshak.."List:Rd:Sudo:mz", text)
...
local listmz = Redis:smembers(Tshak.."List:Rd:Sudo:mz")
...
if x then
local anemi = Redis:get(Tshak.."Add:Rd:Sudo:mz:Gif"..x)   
local veico = Redis:get(Tshak.."Add:Rd:Sudo:mz:vico"..x)   
local stekr = Redis:get(Tshak.."Add:Rd:Sudo:mz:stekr"..x)     
local Text = Redis:get(Tshak.."Add:Rd:Sudo:mz:Text"..x)   
local photo = Redis:get(Tshak.."Add:Rd:Sudo:mz:Photo"..x)
local photoc = Redis:get(Tshak.."Add:Rd:Sudo:mz:Photoc"..x)
local video = Redis:get(Tshak.."Add:Rd:Sudo:mz:Video"..x)
local videoc = Redis:get(Tshak.."Add:Rd:Sudo:mz:Videoc"..x)
local document = Redis:get(Tshak.."Add:Rd:Sudo:mz:File"..x)
local audio = Redis:get(Tshak.."Add:Rd:Sudo:mz:Audio"..x)
local audioc = Redis:get(Tshak.."Add:Rd:Sudo:mz:Audioc"..x)
local video_note = Redis:get(Tshak.."Add:Rd:Sudo:mz:video_note"..x)
if Text then 
local UserInfo = bot.getUser(senderr)
local NumMsg = Redis:get(Tshak..'Num:Message:User'..msg_chat_id..':'..senderr) or 0
local TotalMsg = Total_message(NumMsg)
...
if video_note then
bot.sendVideoNote(msg_chat_id, msg.id, video_note)
Redis:sadd(Tshak.."Spam:Group"..senderr,text) 
end
if photo then
...
Redis:set(Tshak.."Set:Rd:mz"..senderr..":"..msg_chat_id,true)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
Redis:set(Tshak.."Set:On:mz"..senderr..":"..msg_chat_id,true)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if text and not Redis:sismember(Tshak.."Spam:Group"..senderr,text) then
Redis:del(Tshak.."Spam:Group"..senderr) 
end
...
local list = Redis:smembers(Tshak.."List:Rd:Sudo:mz")
for k,v in pairs(list) do
Redis:del(Tshak.."Add:Rd:Sudo:mz:Gif"..v)
Redis:del(Tshak.."Add:Rd:Sudo:mz:vico"..v)
Redis:del(Tshak.."Add:Rd:Sudo:mz:stekr"..v)
Redis:del(Tshak.."Add:Rd:Sudo:mz:Text"..v)
Redis:del(Tshak.."Add:Rd:Sudo:mz:Photo"..v)
Redis:del(Tshak.."Add:Rd:Sudo:mz:Photoc"..v)
Redis:del(Tshak.."Add:Rd:Sudo:mz:Video"..v)
Redis:del(Tshak.."Add:Rd:Sudo:mz:Videoc"..v)
Redis:del(Tshak.."Add:Rd:Sudo:mz:File"..v)
Redis:del(Tshak.."Add:Rd:Sudo:mz:Audio"..v)
Redis:del(Tshak.."Add:Rd:Sudo:mz:Audioc"..v)
Redis:del(Tshak.."Add:Rd:Sudo:mz:video_note"..v)
Redis:del(Tshak.."List:Rd:Sudo:mz")
end
...
for k,v in pairs(list) do
if Redis:get(Tshak.."Add:Rd:Sudo:mz:Gif"..v) then
db = "متحركه •"
elseif Redis:get(Tshak.."Add:Rd:Sudo:mz:vico"..v) then
db = "بصمه •"
elseif Redis:get(Tshak.."Add:Rd:Sudo:mz:stekr"..v) then
db = "ملصق •"
elseif Redis:get(Tshak.."Add:Rd:Sudo:mz:Text"..v) then
db = "رساله •"
elseif Redis:get(Tshak.."Add:Rd:Sudo:mz:Photo"..v) then
db = "صوره •"
elseif Redis:get(Tshak.."Add:Rd:Sudo:mz:Video"..v) then
db = "فيديو •"
elseif Redis:get(Tshak.."Add:Rd:Sudo:mz:File"..v) then
db = "ملف •"
elseif Redis:get(Tshak.."Add:Rd:Sudo:mz:Audio"..v) then
db = "اغنيه •"
elseif Redis:get(Tshak.."Add:Rd:Sudo:mz:video_note"..v) then
db = "بصمه فيديو •"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
local File = json:decode(https.request('https://api.telegram.org/bot' .. Token .. '/getfile?file_id='..mr) ) 
local voicee = 'https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path
local url = https.request("https://Tshakbotss.herokuapp.com/yt?vi="..voicee)
local json = JSON.decode(url)
if json and json.text then
return send(msg.chat_id,msg.id,"• "..json.text)
else
...
Redis:del(Tshak..senderr..msg.chat_id.."num")
...
Redis:set(Tshak.."hms:"..testhms.."chat_id", msg_chat_id)
Redis:set(Tshak.."hms:"..testhms.."to", Message_Reply.sender_id.user_id)
Redis:set(Tshak.."hms:"..testhms.."msg_id",msg.reply_to_message_id)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)  
Redis:del(Tshak..'Text:Games:audio'..Message_Reply.content.audio.audio.remote.id)  
Redis:srem(Tshak.."audio:Games:Bot",Message_Reply.content.audio.audio.remote.id)  
...
Redis:set(Tshak.."Add:audio:Games"..senderr..":"..msg.chat_id,'start')
...
local list = Redis:smembers(Tshak.."audio:Games:Bot")
if #list == 0 then
...
for k,v in pairs(list) do
Redis:del(Tshak..'Text:Games:audio'..v)  
Redis:srem(Tshak.."audio:Games:Bot",v)  
end
...
local GetAnswer = Redis:get(Tshak..'Text:Games:audio'..quschen)
Redis:set(Tshak..'Games:Set:Answer'..msg.chat_id,GetAnswer)
...
if not Redis:get(Tshak..'lock_geamsAudio'..msg.chat_id) then 
...
if Redis:get(Tshak..'lock_geamsAudio'..msg.chat_id) then 
return send(msg_chat_id,msg_id,"• أهلا عزيزي "..msg.Name_Controller.."\n• الصوتيات العامه بالتأكيد معطله\n✓" )
else
Redis:set(Tshak..'lock_geamsAudio'..msg.chat_id,true)  
...
if not Redis:get(Tshak..'lock_geamsAudio1'..msg.chat_id) then 
...
if Redis:get(Tshak..'lock_geamsAudio1'..msg.chat_id) then 
return send(msg_chat_id,msg_id,"• أهلا عزيزي "..msg.Name_Controller.."\n• الصوتيات بالتأكيد معطله\n✓" )
else
Redis:set(Tshak..'lock_geamsAudio1'..msg.chat_id,true)  
return send(msg_chat_id,msg_id,"• أهلا عزيزي "..msg.Name_Controller.."\n• تم تعطيل الصوتيات\n✓" )
end   
end

if text == 'الروليت' then
if not Redis:get(Tshak.."Status:Games"..msg.chat_id) then
return false
end
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Tshak..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Tshak..'Chat:Channel:Join'..msg.chat_id)}, },}}
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text = Get_Chat.title, url = LinkGroup.invite_link},},}}
Redis:set(Tshak.."PV:invite_link:"..msg.chat_id, LinkGroup.invite_link)
return send(msg_chat_id, msg_id, "⌯ Link Group : \n["..LinkGroup.invite_link.. "]", 'md', true, false, false, false, reply_markup)
end
--- سي في 
jobs_ = {
...
Redis:del(Tshak..":CV:Text:"..msg.chat_id)
...
if not Redis:get(Tshak..":CV:Name:"..msg.sender_id.user_id..":"..msg.chat_id) then
return send(msg_chat_id,msg_id,'\n⌯ لا يوجد سي في باسمك',"md",true)  
end
Redis:del(Tshak..":CV:Address:"..msg.sender_id.user_id..":"..msg.chat_id)
Redis:del(Tshak..":CV:Age:"..msg.sender_id.user_id..":"..msg.chat_id)
Redis:del(Tshak..":CV:Name:"..msg.sender_id.user_id..":"..msg.chat_id)
...
if Redis:get(Tshak..":CV:Name:"..msg.sender_id.user_id..":"..msg.chat_id) then
return send(msg_chat_id,msg_id,'\n⌯ انت تمتلك سي في باسمك اكتب ( `عرض سي في` ) لتتمكن من رؤيه السي في',"md",true)  
end
Redis:set(Tshak..":CV:set:"..msg.sender_id.user_id..":"..msg.chat_id, "Name")
return send(msg_chat_id,msg_id,'\n⌯ مرحبا بك في السجل المدني الخاص بسورس 𝐂𝐀𝐄𝐒𝐀𝐑\nاكتب اسمك الان :',"md",true)  
end

if text and Redis:get(Tshak..":CV:set:"..msg.sender_id.user_id..":"..msg.chat_id) == "Name" then 
local name = FlterBio(text)
Redis:set(Tshak..":CV:Name:"..msg.sender_id.user_id..":"..msg.chat_id, name)
Redis:set(Tshak..":CV:set:"..msg.sender_id.user_id..":"..msg.chat_id, "Jobs")
return send(msg_chat_id,msg_id,'\n⌯ تم حفظ اسمك بنجاح\nاكتب وظيفتك الان :',"md",true)
end

if text and Redis:get(Tshak..":CV:set:"..msg.sender_id.user_id..":"..msg.chat_id) == "Jobs" then 
local name = FlterBio(text)
Redis:set(Tshak..":CV:Jobs:"..msg.sender_id.user_id..":"..msg.chat_id, name)
Redis:set(Tshak..":CV:set:"..msg.sender_id.user_id..":"..msg.chat_id, "Age")
return send(msg_chat_id,msg_id,'\n⌯ تم حفظ اسمك بنجاح\nاكتب عمرك الان :',"md",true)
end

if text and Redis:get(Tshak..":CV:set:"..msg.sender_id.user_id..":"..msg.chat_id) == "Age" then 
if not text:match('(%d+)') then 
return send(msg_chat_id,msg_id,'\n⌯ ادخل عمرك بالارقام لو سمحت',"md",true)
end
Redis:set(Tshak..":CV:Age:"..msg.sender_id.user_id..":"..msg.chat_id, text)
Redis:set(Tshak..":CV:set:"..msg.sender_id.user_id..":"..msg.chat_id, "Address")
return send(msg_chat_id,msg_id,'\n⌯ تم حفظ عمرك بنجاح\nاكتب عنوانك الان :',"md",true)
end

if text and Redis:get(Tshak..":CV:set:"..msg.sender_id.user_id..":"..msg.chat_id) == "Address" then 
local address = FlterBio(text)
Redis:set(Tshak..":CV:Address:"..msg.sender_id.user_id..":"..msg.chat_id, address)
Redis:del(Tshak..":CV:set:"..msg.sender_id.user_id..":"..msg.chat_id)
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
if Redis:get(Tshak..":CV:Name:"..Message_Reply.sender_id.user_id..":"..msg.chat_id) then
local name = Redis:get(Tshak..":CV:Name:"..Message_Reply.sender_id.user_id..":"..msg.chat_id)
local age = Redis:get(Tshak..":CV:Age:"..Message_Reply.sender_id.user_id..":"..msg.chat_id)
local address = Redis:get(Tshak..":CV:Address:"..Message_Reply.sender_id.user_id..":"..msg.chat_id)
local jobs = Redis:get(Tshak..":CV:Jobs:"..Message_Reply.sender_id.user_id..":"..msg.chat_id)
--- cv text
local CV_Text = Redis:get(Tshak..":CV:Text:"..msg.chat_id) or "⌯ الاسم : #Name \n⌯ العمر : #Age \n⌯ الاقامه : #Address \n⌯ الوظيفه : #Jobs \n⌯ شخصيته : #Personal"
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
if not Redis:get(Tshak..":CV:Name:"..Message_Reply.sender_id.user_id..":"..msg.chat_id) then
...
if not Redis:get(Tshak..":CV:Name:"..msg.sender_id.user_id..":"..msg.chat_id) then -- if not rep
return send(msg_chat_id,msg_id,'\n⌯ انت لا تمتلك سي في باسمك اكتب ( `اضف سي في` ) لتتمكن من اضافه السي في',"md",true)  
end -- end if not rep
local name = Redis:get(Tshak..":CV:Name:"..msg.sender_id.user_id..":"..msg.chat_id)
local age = Redis:get(Tshak..":CV:Age:"..msg.sender_id.user_id..":"..msg.chat_id)
local address = Redis:get(Tshak..":CV:Address:"..msg.sender_id.user_id..":"..msg.chat_id)
local jobs = Redis:get(Tshak..":CV:Jobs:"..msg.sender_id.user_id..":"..msg.chat_id)
--- cv text
local CV_Text = Redis:get(Tshak..":CV:Text:"..msg.chat_id) or "⌯ الاسم : #Name \n⌯ العمر : #Age \n⌯ الاقامه : #Address \n⌯ الوظيفه : #Jobs \n⌯ شخصيته : #Personal"
local CV_Text = CV_Text:gsub('#Name',name) 
local CV_Text = CV_Text:gsub('#Age',age) 
...
Redis:set(Tshak..":CV:set:"..msg.sender_id.user_id..":"..msg.chat_id, "Text")
return send(msg_chat_id,msg_id,'\n⌯ ارسل الكلياشه الان :\n⌯ مع استبدال \nالاسم = `#Name`\nالعمر = `#Age`\nالعنوان = `#Address`\nالوظيفه = `#Jobs`\nالشخصيه = `#Personal`\n \n⌯اضغط علي الداله للنسخ',"md",true)  
end

if text and Redis:get(Tshak..":CV:set:"..msg.sender_id.user_id..":"..msg.chat_id) == "Text" then
Redis:set(Tshak..":CV:Text:"..msg.chat_id, text)
Redis:del(Tshak..":CV:set:"..msg.sender_id.user_id..":"..msg.chat_id)
...
Redis:set(Tshak.."gamebot:new"..senderr..":"..msg.chat_id,true)
...
Redis:set(Tshak.."gamebot:new"..senderr..":"..msg.chat_id,'truedel')
return send(msg_chat_id,msg_id,"ارسل السؤال الان ")
end
...
Redis:set(Tshak.."lkz:gamebot:new"..senderr..":"..msg.chat_id,true)
...
Redis:set(Tshak.."lkz:gamebot:new"..senderr..":"..msg.chat_id,'truedel')
return send(msg_chat_id,msg_id,"ارسل اللغز الان ")
end
...
if not Redis:get(Tshak.."amrthshesh"..msg.chat_id) then    
Redis:set(Tshak..":"..senderr..":lov_Bots"..msg.chat_id,"sendlove")
...
if not Redis:get(Tshak.."amrthshesh"..msg.chat_id) then    
Redis:set(Tshak..":"..senderr..":lov_Bottts"..msg.chat_id,"sendlove")
...
if not Redis:get(Tshak.."amrthshesh"..msg.chat_id) then    
Redis:set(Tshak..":"..senderr..":lov_Botttuus"..msg.chat_id,"sendlove")
hggg = '• الان ارسل اسم الشخص :'
send(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(Tshak.."amrthshesh"..msg.chat_id) then    
Redis:set(Tshak..":"..senderr..":krh_Bots"..msg.chat_id,"sendkrhe")
hggg = '• الان ارسل اسمك واسم الشخص الثاني :'
send(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(Tshak.."amrthshesh"..msg.chat_id) then    
Redis:set(Tshak..":"..senderr..":rjo_Bots"..msg.chat_id,"sendrjoe")
hggg = '• الان ارسل اسم الشخص :'
send(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(Tshak.."amrthshesh"..msg.chat_id) then    
Redis:set(Tshak..":"..senderr..":ano_Bots"..msg.chat_id,"sendanoe")
hggg = '• الان ارسل اسم الشخص :'
send(msg_chat_id,msg_id,hggg) 
return false
end
...
if text and text:match("^برج (.*)$") and Redis:get(Tshak.."brj_Bots"..msg.chat_id) == "open" then
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Tshak..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Tshak..'Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'*\n• عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end
...
local ahkam = Redis:smembers(Tshak.."Ahkam_list:")
local list = "• قائمه الاحكام :\n"
for k,v in pairs(Redis:smembers(Tshak.."Ahkam_list:")) do
list = list..k.." - "..v.."\n"
end
if #ahkam == 0 then
list = "• لا توجد احكام"
...
Redis:del(Tshak.."Ahkam_list:")
send(msg_chat_id,msg_id,"• تم حذف قائمه الاحكام بنجاح")
end

if text and Redis:get(Tshak.."Ahkam:del"..msg.sender_id.user_id..":"..msg_chat_id) then
if not Redis:sismember(Tshak.."Ahkam_list:", text) then
return send(msg_chat_id,msg_id,"• لا يوجد حكم هكذا")
end
Redis:srem(Tshak.."Ahkam_list:", text)
Redis:del(Tshak.."Ahkam:del"..msg.sender_id.user_id..":"..msg_chat_id)
...
Redis:set(Tshak.."Ahkam:del"..msg.sender_id.user_id..":"..msg_chat_id,true)
send(msg.chat_id,msg.id,"• ارسل الحكم الان")
end

if text and Redis:get(Tshak.."Ahkam:set"..msg.sender_id.user_id..":"..msg_chat_id) then
Redis:sadd(Tshak.."Ahkam_list:", text)
Redis:del(Tshak.."Ahkam:set"..msg.sender_id.user_id..":"..msg_chat_id)
...
Redis:set(Tshak.."Ahkam:set"..msg.sender_id.user_id..":"..msg_chat_id,true)
send(msg.chat_id,msg.id,"• ارسل الحكم الان")
end
Ahkam_list = {
  "احذف حسابك",
...
Redis:sadd(Tshak.."Ahkam:"..Anubis..":chat_id:"..msg_chat_id, msg.sender_id.user_id)
Redis:set(Tshak.."in_game:"..msg.sender_id.user_id, Anubis)
local reply_markup = bot.replyMarkup{
  type = 'inline',
  data = {
...
if text == "بدء" then 
if Redis:get(Tshak.."in_game:"..msg.sender_id.user_id) then
local Anubis = Redis:get(Tshak.."in_game:"..msg.sender_id.user_id)
local numR = Redis:smembers(Tshak.."Ahkam_ready:"..Anubis..":chat_id:"..msg_chat_id)
local numN = Redis:smembers(Tshak.."Ahkam:"..Anubis..":chat_id:"..msg_chat_id)
if #numR < #numN  then -- check on players no.
Redis:sadd(Tshak.."Ahkam_ready:"..Anubis..":chat_id:"..msg_chat_id, msg.sender_id.user_id)
...
local Redis_Ahkam = Redis:smembers(Tshak.."Ahkam_list:")
...
Redis:del(Tshak..'sh3ir:Abs'..msg.chat_id) 
end
...
local F333F = ' \n✯︙تم تعطيل شعر'
send(msg_chat_id,msg_id,F333F,"md")
Redis:set(Tshak..'sh3ir:Abs'..msg.chat_id,true)  
end
if text and (text == "شعر" or text == "↫ شعر ✯") and not Redis:get(Tshak..'sh3ir:Abs'..msg.chat_id) then
...
if Redis:get(Tshak..'amrthshesh'..msg.chat_id)  then
return send(msg_chat_id,msg_id,'• تم تعطيل التسليه مسبقا\n ✓',"md")
else
Redis:set(Tshak.."amrthshesh"..msg.chat_id,"true")
...
Redis:set(Tshak.."Add:audio:Games"..senderr..":"..msg.chat_id,'startdel')
...
local list = Redis:smembers(Tshak.."text:Games:Bot"..msg.chat_id)
if #list == 0 then
...
for k,v in pairs(list) do
Redis:srem(Tshak.."text:Games:Bot"..msg.chat_id,v)
Redis:del(Tshak.."audio:Games"..msg.chat_id..v)
end
...
Redis:set(Tshak.."All:Add:audio:Games"..senderr..":"..msg.chat_id,'startdel')
...
Redis:set(Tshak.."All:Add:audio:Games"..senderr..":"..msg.chat_id,'start')
...
local list = Redis:smembers(Tshak.."All:text:Games:Bot")
if #list == 0 then
send(msg_chat_id,msg_id, "• لا توجد صوتيات عامه")
return false
end
...
for k,v in pairs(list) do
Redis:srem(Tshak.."All:text:Games:Bot",v)
Redis:del(Tshak.."All:audio:Games"..v)
end
send(msg_chat_id,msg_id, "• تم مسح جميع الصوتيات")
end
...
if Redis:get(Tshak..'kadmeat'..msg.chat_id)  then
send(msg_chat_id,msg_id, '• تم تعطيل اوامر الصيغ مسبقا\n ✓',"md")
else
Redis:set(Tshak.."kadmeat"..msg.chat_id,"true")
...
if not Redis:get(Tshak..'kadmeat'..msg.chat_id)  then
...
if Redis:get(Tshak..'intg'..msg.chat_id)  then
send(msg_chat_id,msg_id, '• تم تعطيل امر انطق مسبقا\n ✓',"md")
else
Redis:set(Tshak.."intg"..msg.chat_id,"true")
...
if not Redis:get(Tshak..'intg'..msg.chat_id)  then
...
if Redis:get(Tshak..'knele'..msg.chat_id)  then
send(msg_chat_id,msg_id, '• تم تعطيل امر غنيلي مسبقا\n ✓',"md")
else
Redis:set(Tshak.."knele"..msg.chat_id,"true")
...
if not Redis:get(Tshak..'knele'..msg.chat_id)  then
...
if Redis:get(Tshak..'brjj'..msg.chat_id)  then
send(msg_chat_id,msg_id, '• تم تعطيل امر الابراج مسبقا\n ✓',"md")
else
Redis:set(Tshak.."brjj"..msg.chat_id,"true")
...
if not Redis:get(Tshak..'brjj'..msg.chat_id)  then
...
local F333F = ' \n• تم تفعيل المتحركه'
send(msg_chat_id,msg_id,F333F,"md")
Redis:del(Tshak..'Abs:gif:Abs'..msg.chat_id) 
end
...
local F333F = ' \n• تم تعطيل المتحركه'
send(msg_chat_id,msg_id,F333F,"md")
Redis:set(Tshak..'Abs:gif:Abs'..msg.chat_id,true)  
end
if text and (text == "متحركه" or text == "↫ متحركه ✯") and not Redis:get(Tshak..'Abs:gif:Abs'..msg.chat_id) then
...
local F333F = ' \n• تم تفعيل الميمز'
send(msg_chat_id,msg_id,F333F,"md")
Redis:del(Tshak..'Abs:memz:Abs'..msg.chat_id) 
end
...
local F333F = ' \n• تم تعطيل الميمز'
send(msg_chat_id,msg_id,F333F,"md")
Redis:set(Tshak..'Abs:memz:Abs'..msg.chat_id,true)  
end
if text and (text == "ميمز" or text == "↫ ميمز ✯") and not Redis:get(Tshak..'Abs:memz:Abs'..msg.chat_id) then
...
local F333F = ' \n• تم تفعيل الريمكس'
send(msg_chat_id,msg_id,F333F,"md")
Redis:del(Tshak..'Abs:Remix:Abs'..msg.chat_id) 
end
...
local F333F = ' \n• تم تعطيل الريمكس'
send(msg_chat_id,msg_id,F333F,"md")
Redis:set(Tshak..'Abs:Remix:Abs'..msg.chat_id,true)  
end
if text and (text == "ريمكس" or text == "↫ ريمكس ✯") and not Redis:get(Tshak..'Abs:Remix:Abs'..msg.chat_id) then
...
local F333F = ' \n• تم تفعيل الصوره'
send(msg_chat_id,msg_id,F333F,"md")
Redis:del(Tshak..'Abs:Photo:Abs'..msg.chat_id) 
end
...
local F333F = ' \n• تم تعطيل الصوره'
send(msg_chat_id,msg_id,F333F,"md")
Redis:set(Tshak..'Abs:Photo:Abs'..msg.chat_id,true)  
end
if text and (text == "صوره" or text == "↫ صوره ✯") and not Redis:get(Tshak..'Abs:Photo:Abs'..msg.chat_id) then
...
local F333F = ' \n• تم تفعيل الانمي'
send(msg_chat_id,msg_id,F333F,"md")
Redis:del(Tshak..'Abs:Anime:Abs'..msg.chat_id) 
end
...
local F333F = ' \n• تم تعطيل الانمي'
send(msg_chat_id,msg_id,F333F,"md")
Redis:set(Tshak..'Abs:Anime:Abs'..msg.chat_id,true)  
end
if text and (text == "انمي" or text == "↫ انمي ✯") and not Redis:get(Tshak..'Abs:Anime:Abs'..msg.chat_id) then
...
local F333F = ' \n• تم تفعيل الافلام'
send(msg_chat_id,msg_id,F333F,"md")
Redis:del(Tshak..'Abs:Movies:Abs'..msg.chat_id) 
end
...
local F333F = ' \n• تم تعطيل الافلام'
send(msg_chat_id,msg_id,F333F,"md")
Redis:set(Tshak..'Abs:Movies:Abs'..msg.chat_id,true)  
end
if text and (text == "فلم" or text == "↫ فلم ✯") and not Redis:get(Tshak..'Abs:Movies:Abs'..msg.chat_id) then
...
local F333F = ' \n• تم تفعيل المسلسلات'
send(msg_chat_id,msg_id,F333F,"md")
Redis:del(Tshak..'Abs:Series:Abs'..msg.chat_id) 
end
...
local F333F = ' \n• تم تعطيل المسلسلات'
send(msg_chat_id,msg_id,F333F,"md")
Redis:set(Tshak..'Abs:Series:Abs'..msg.chat_id,true)  
end
if text and (text == "مسلسل" or text == "↫ مسلسل ✯") and not Redis:get(Tshak..'Abs:Series:Abs'..msg.chat_id) then
...
if Redis:get(Tshak..'mynames'..msg.chat_id)  then
return send(msg_chat_id,msg_id,'• تم تعطيل معنى اسم مسبقا\n ✓',"md")
else
Redis:set(Tshak.."mynames"..msg.chat_id,"true")
...
Redis:del(Tshak.."mynames"..msg.chat_id)
...
if not Redis:get(Tshak..'kolklma'..msg.chat_id)  then
return send(msg_chat_id,msg_id,'• تم تعطيل قول مسبقا\n ✓',"md")
else
Redis:del(Tshak.."kolklma"..msg.chat_id)
...
if Redis:get(Tshak..'kolklma'..msg.chat_id)  then
return send(msg_chat_id,msg_id,'• تم تفعيل قول مسبقا\n ✓',"md")
else
Redis:set(Tshak.."kolklma"..msg.chat_id,"true")
return send(msg_chat_id,msg_id,'• تم تفعيل قول\n ✓',"md")
end
end
if text and text:match("^قول (.*)$") and Redis:get(Tshak..'kolklma'..msg.chat_id) then
...
if Redis:get(Tshak..'myniknea'..msg.chat_id)  then
return send(msg_chat_id,msg_id,'• تم تعطيل اغنيه مسبقا\n ✓',"md")
else
Redis:set(Tshak.."myniknea"..msg.chat_id,"true")
...
if not Redis:get(Tshak..'myniknea'..msg.chat_id)  then
return send(msg_chat_id,msg_id,'• تم تفعيل اغنيه مسبقا\n ✓',"md")
else
Redis:del(Tshak.."myniknea"..msg.chat_id)
...
Redis:del(Tshak.."mybuti"..msg_chat_id)
...
Redis:set(Tshak.."mybuti"..msg_chat_id,"off")
...
if q:match("%a") then
local url = https.request("https://xnxx.Tshakbots.ml/apies/playstore.php?q="..URL.escape(q))
local json = JSON.decode(url)
...
Redis:setex(Tshak.."Change:Name:Bot"..senderr,300,true) 
...
Redis:del(Tshak.."Name:Bot") 
return send(msg_chat_id,msg_id,"• تم مسح اسم البوت ","md",true)   
end
if text == (Redis:get(Tshak.."Name:Bot") or "قيصر") then
local photo = bot.getUserProfilePhotos(Tshak)
if photo.total_count > 0 then
local NamesBot = (Redis:get(Tshak.."Name:Bot") or "قيصر")
local Mostafa = {
'• مالك حبيبى 🥺',
...
if Redis:get(Tshak.."name bot type : ") == "photo" then
  
    local photo = bot.getUserProfilePhotos(Tshak)
    local UserInfo = bot.getUser(Tshak)
...
if ChatAction.Tshakbots ~= "ok" then
x = x + 1
Redis:srem(Tshak..'Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = bot.getChat(v)
if Get_Chat.id then
local statusMem = bot.getChatMember(Get_Chat.id,Tshak)
if statusMem.status.Tshakbots == "chatMemberStatusMember" then
x = x + 1
send(Get_Chat.id,0,'*• البوت عضو في الجروب سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(Tshak..'ChekBotAdd',Get_Chat.id)
...
Redis:del(Tshak.."Num:Add:Games"..msg.chat_id..senderr)
...
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تن','تنزيل الكل')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','الردود')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مس','مسح تعديلاتي')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ن','نقاطي')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'س','اسالني')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ل','لغز')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مع','معاني')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ح','حزوره')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رف','رفع القيود')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'الغ','الغاء حظر')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ث','تثبيت')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ك','كشف')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تت','تاك')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تاك للكل')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تغ','تغيير الايدي')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تنز','تنزيل جميع الرتب')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'قق','قفل الاشعارات')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'فف','فتح الاشعارات')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مر','مسح رد')
Redis:set(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'امر','اضف امر')
...
Redis:sadd(Tshak.."Command:List:Group"..msg_chat_id.."",v)
end
return send(msg_chat_id,msg_id,[[*
...
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تن','تنزيل الكل')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','الردود')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مس','مسح تعديلاتي')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ن','نقاطي')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'س','اسالني')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ل','لغز')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مع','مغاني')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ح','حزوره')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رف','رفع القيود')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'الغ','الغاء حظر')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ث','تثبيت')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ك','كشف')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تت','تاك')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تاك للكل')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تغ','تغيير الايدي')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تنزل','تنزيل جميع الرتب')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'قق','قفل الاشعارات')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'فف','فتح الاشعارات')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مر','مسح رد')
Redis:del(Tshak.."Get:Reides:Commands:Group"..msg_chat_id..":"..'امر','اضف امر')
return send(msg_chat_id,msg_id,[[*
• تم استعاده الاوامر
*]],"md")
end
...
if tonumber(msg.sender_id.user_id) ~= tonumber(Redis:get(Tshak..":7azer:"..Anubis[1])) then
return send(msg_user_send_id,msg_id,'• هذا الامر لا يخصك',"md",true) 
end
local mem_num = Redis:smembers(Tshak..":7azer:mem:"..Anubis[1])
if #mem_num == 0 then
return send(msg_user_send_id,msg_id,'• انتظر حتي انضمام لاعب واحد علي الاقل',"md",true) 
end
Redis:set(Tshak..":7azer:chat_id"..msg_user_send_id, Anubis[1])
Redis:set(Tshak..":7azer:state"..msg_user_send_id, 'quiz')
return send(msg_user_send_id,msg_id,'• ارسل السؤال الان',"md",true)  
end
elseif not text:match("(.*)start(.*)") and Redis:get(Tshak..":7azer:state"..msg_user_send_id) == 'quiz' then
local chat = Redis:get(Tshak..":7azer:chat_id"..msg_user_send_id)
Redis:set(Tshak..":7azer:quiz"..chat, text)
Redis:set(Tshak..":7azer:state"..msg_user_send_id, 'answer')
return send(msg_chat_id,msg_id,"• ارسل الاجابه بدون علامات مميزه","md",true,false,false,false)
elseif not text:match("(.*)start(.*)") and Redis:get(Tshak..":7azer:state"..msg_user_send_id) == 'answer' then
local chat = Redis:get(Tshak..":7azer:chat_id"..msg_user_send_id)
local quiz = Redis:get(Tshak..":7azer:quiz"..chat)
Redis:set(Tshak..":7azer:answer"..chat, text)
Redis:del(Tshak..":7azer:state"..msg_user_send_id)
send(chat,0,"• السؤال :\n- "..quiz.."\n\n• معكم ( `"..ctime(180).."` ) لحل السؤال","md",true,false,false,false)
Redis:setex(Tshak..":7azer:"..chat, 180, msg.sender_id.user_id)
Redis:del(Tshak..":7azer:quiz"..chat)
...
Redis:set(Tshak.."hms:"..msg_user_send_id, testhms[1])
return send(msg_user_send_id,msg_id,'• ارسل الهمسه الان',"md",true)  
end
elseif not text:match("(.*)start(.*)") and Redis:get(Tshak.."hms:"..msg_user_send_id) then
local testhms = Redis:get(Tshak.."hms:"..msg_user_send_id)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
Redis:set(Tshak.."hms:"..testhms.."text:", text)
...
if text == '/start' then
Redis:sadd(Tshak..'Num:User:Pv',msg.sender_id.user_id)  
if not msg.Asasy then
if not Redis:get(Tshak.."Start:Bot") then
local photo = bot.getUserProfilePhotos(Tshak)
local UserInfo = bot.getUser(Tshak)
local Name_User = UserInfo.first_name
local Name_dev = bot.getUser(Sudo_Id).first_name
local UName_dev = bot.getUser(Sudo_Id).username
local CmdStart = '*\n🤖╖ أهلآ بك في بوت '..(Redis:get(Tshak.."Name:Bot") or "[قيصر]")..
...
return send(msg_chat_id,msg_id,Redis:get(Tshak.."Start:Bot"),"md",false, false, false, false, reply_markup)
end
end
else
local reply_markup = bot.replyMarkup{type = 'keyboard',resize = true,is_personal = true,
...
if text and Redis:get(Tshak.."set:chsource"..senderr) then
if text == "الغاء الامر •" then
Redis:del(Tshak.."set:chsource"..senderr)
return send(msg_chat_id,msg_id,'تم الغاء الامر بنجاح ',"md",true)  
end
if text:match("^@(.*)$") then
Redis:del(Tshak.."set:chsource"..senderr)
local chsource = text:match("^@(.*)$") 
Redis:set(Tshak..'chsource',chsource)
send(msg_chat_id,msg_id,'\n• تم حفظ قناه السورس')
dofile('Tshak.lua')  
else
...
Redis:set(Tshak.."set:chsource"..senderr,true)
send(msg_chat_id,msg_id,'• ارسل الان معرف قناه السورس ',"md",true)  
end
if text and Redis:get(Tshak.."set:devsource"..senderr) then
if text == "الغاء الامر •" then
Redis:del(Tshak.."set:devsource"..senderr)
return send(msg_chat_id,msg_id,'تم الغاء الامر بنجاح ',"md",true)  
end
if text:match("^@(.*)$") then
Redis:del(Tshak.."set:devsource"..senderr)
local chsource = text:match("^@(.*)$") 
Redis:set(Tshak..'devsource',chsource)
send(msg_chat_id,msg_id,'\n• تم حفظ مطور السورس')
dofile('Tshak.lua')  
else
send(msg_chat_id,msg_id,'\n• ارسل المعرف بشكل صحيح')
...
Redis:set(Tshak.."set:devsource"..senderr,true)
send(msg_chat_id,msg_id,'• ارسل الان معرف مطور السورس ',"md",true)  
end
if Redis:get(Tshak.."set:rmz"..senderr) then
if text then
if text == "الغاء الامر •" then
Redis:del(Tshak.."set:rmz"..senderr)
return send(msg_chat_id,msg_id,'تم الغاء الامر بنجاح ',"md",true)  
end
Redis:set(Tshak..'rmzsource',text)
Redis:del(Tshak.."set:rmz"..senderr)
...
Redis:set(Tshak.."set:rmz"..senderr,true)
...
if text == "تفعيل البوت بصوره ❍" then
  ...
  Redis:set(Tshak.."name bot type : ", "photo")
...
Redis:set(Tshak.."name bot type : ", "text")
...
Redis:setex(Tshak.."Change:Start:Bot"..senderr,300,true) 
...
if not msg.Asasy then
if Redis:get(Tshak.."TwaslBot") and not Redis:sismember(Tshak.."BaN:In:Tuasl",senderr) then
...
Redis:setex(Tshak.."Twasl:UserId"..msg.date,172800,IdUser)
if FedMsg.content.Tshakbots == "messageSticker" then
...
local Info_User = Redis:get(Tshak.."Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(Tshak..'BaN:In:Tuasl',Info_User)  
return send(msg_chat_id,msg_id,Reply_Status(Info_User,'• تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(Tshak..'BaN:In:Tuasl',Info_User)  
